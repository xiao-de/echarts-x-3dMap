...
function(e) {
    function t(e, t, i, a, o) {
        ...
        this._curMapType,
        this.refresh(a),
        this.zr.on(d.EVENT.MOUSEWHEEL, this._onmousewheel),
        this.zr.on(d.EVENT.MOUSEDOWN, this._onmousedown),
        t.bind(m.EVENT.ROAMCONTROLLER, this._onroamcontroller),
    ...
    return t.prototype = {
        ...
        _buildShape: function() {
            ...
            this.selectedMap = {},
            this._activeMapType = {};
            for (var t, n, i, a, o = this.component.legend,
            r = {},
            s = {},
            l = {},
            h = {},
            V = 0,
            d = e.length; d > V; V++) if (e[V].type == m.CHART_TYPE_MAP && (e[V] = this.reformOption(e[V]), n = e[V].mapType, s[n] = s[n] || {},
            s[n][V] = !0, l[n] = l[n] || e[V].mapValuePrecision, this._scaleLimitMap[n] = this._scaleLimitMap[n] || {},
            e[V].scaleLimit && U.merge(this._scaleLimitMap[n], e[V].scaleLimit, !0), this._roamMap[n] = e[V].roam || this._roamMap[n], this._hoverLinkMap[n] = e[V].dataRangeHoverLink || this._hoverLinkMap[n], this._nameMap[n] = this._nameMap[n] || {},
            e[V].nameMap && U.merge(this._nameMap[n], e[V].nameMap, !0), this._activeMapType[n] = !0, e[V].textFixed && U.merge(u, e[V].textFixed, !0), e[V].geoCoord && U.merge(y, e[V].geoCoord, !0), this._selectedMode[n] = this._selectedMode[n] || e[V].selectedMode, (null == this._hoverable[n] || this._hoverable[n]) && (this._hoverable[n] = e[V].hoverable), (null == this._clickable[n] || this._clickable[n]) && (this._clickable[n] = e[V].clickable), (null == this._showLegendSymbol[n] || this._showLegendSymbol[n]) && (this._showLegendSymbol[n] = e[V].showLegendSymbol), h[n] = h[n] || e[V].mapValueCalculation, t = e[V].name, this.selectedMap[t] = o ? o.isSelected(t) : !0, this.selectedMap[t])) {
                r[n] = r[n] || {},
                i = e[V].data;
                for (var p = 0,
                g = i.length; g > p; p++) {
                    a = this._nameChange(n, i[p].name),
                    r[n][a] = r[n][a] || {
                        seriesIndex: []
                    };
                    for (var b in i[p])"value" != b ? r[n][a][b] = i[p][b] : isNaN(i[p].value) || (null == r[n][a].value && (r[n][a].value = 0), r[n][a].value += +i[p].value);
                    r[n][a].seriesIndex.push(V)
                }
            }
            this._mapDataRequireCounter = 0;
            for (var f in r) this._mapDataRequireCounter++;
            this._clearSelected(),
            0 === this._mapDataRequireCounter && (this.clear(), this.zr && this.zr.delShape(this.lastShapeList), this.lastShapeList = []);
            for (var f in r) {
                if (h[f] && "average" == h[f]) for (var g in r[f]) r[f][g].value = (r[f][g].value / r[f][g].seriesIndex.length).toFixed(l[f]) - 0;
                this._mapDataMap[f] = this._mapDataMap[f] || {},
                this._mapDataMap[f].mapData ? this._mapDataCallback(f, r[f], s[f])(this._mapDataMap[f].mapData) : c[f.replace(/\|.*/, "")].getGeoJson && (this._specialArea[f] = c[f.replace(/\|.*/, "")].specialArea || this._specialArea[f], c[f.replace(/\|.*/, "")].getGeoJson(this._mapDataCallback(f, r[f], s[f])))
            }
        },
        _mapDataCallback: function(t, n, i) {
            var a = this;
            return function(o) {
                a._isAlive && null != a._activeMapType[t] && ( - 1 != t.indexOf("|") && (o = a._getSubMapData(t, o)), a._mapDataMap[t].mapData = o, o.firstChild ? (a._mapDataMap[t].rate = 1, a._mapDataMap[t].projection = e("../util/projection/svg")) : (a._mapDataMap[t].rate = .75, a._mapDataMap[t].projection = e("../util/projection/normal")), a._buildMap(t, a._getProjectionData(t, o, i), n, i), a._buildMark(t, i), 0 >= --a._mapDataRequireCounter && (a.addShapeList(), a.zr.refreshNextFrame()))
            }
        },
        ...
        _getSubMapData: function(e, t) {
            for (var n = e.replace(/^.*\|/, ""), i = t.features, a = 0, o = i.length; o > a; a++) if (i[a].properties && i[a].properties.name == n) {
                i = i[a],
                "United States of America" == n && i.geometry.coordinates.length > 1 && (i = {
                    geometry: {
        ...
        _getProjectionData: function(e, t, n) {
            var i, a = this._mapDataMap[e].projection,
            o = [],
            r = this._mapDataMap[e].bbox || a.getBbox(t, this._specialArea[e]);
            i = this._mapDataMap[e].hasRoam ? this._mapDataMap[e].transform: this._getTransform(r, n, this._mapDataMap[e].rate);
            var s, l = this._mapDataMap[e].lastTransform || {
                scale: {}
            };
            i.left != l.left || i.top != l.top || i.scale.x != l.scale.x || i.scale.y != l.scale.y ? (s = a.geoJson2Path(t, i, this._specialArea[e]), l = U.clone(i)) : (i = this._mapDataMap[e].transform, s = this._mapDataMap[e].pathArray),
            this._mapDataMap[e].bbox = r,
            this._mapDataMap[e].transform = i,
            this._mapDataMap[e].lastTransform = l,
            this._mapDataMap[e].pathArray = s;
            for (var h = [i.left, i.top], m = 0, V = s.length; V > m; m++) o.push(this._getSingleProvince(e, s[m], h));
            if (this._specialArea[e]) for (var d in this._specialArea[e]) o.push(this._getSpecialProjectionData(e, t, d, this._specialArea[e][d], h));
            if ("china" == e) {
                var p = this.geo2pos(e, y["南海诸岛"] || c["南海诸岛"].textCoord),
                g = i.scale.x / 10.5,
                b = [32 * g + p[0], 83 * g + p[1]];
                u["南海诸岛"] && (b[0] += u["南海诸岛"][0], b[1] += u["南海诸岛"][1]),
                o.push({
                    name: this._nameChange(e, "南海诸岛"),
                    path: c["南海诸岛"].getPath(p, g),
                    position: h,
                    textX: b[0],
                    textY: b[1]
                })
        ...
        _getTransform: function(e, t, n) {
            var i, a, o, r, s, l, h, m = this.series,
            V = this.zr.getWidth(),
            U = this.zr.getHeight(),
            d = Math.round(.02 * Math.min(V, U));
            for (var p in t) i = m[p].mapLocation || {},
            o = i.x || o,
            s = i.y || s,
            l = i.width || l,
            h = i.height || h;
            a = this.parsePercent(o, V),
            a = isNaN(a) ? d: a,
            r = this.parsePercent(s, U),
            r = isNaN(r) ? d: r,
            l = null == l ? V - a - 2 * d: this.parsePercent(l, V),
            h = null == h ? U - r - 2 * d: this.parsePercent(h, U);
            var c = e.width,
            u = e.height,
            y = l / n / c,
            g = h / u;
            if (y > g ? (y = g * n, l = c * y) : (g = y, y = g * n, h = u * g), isNaN(o)) switch (o = o || "center", o + "") {
            case "center":
                a = Math.floor((V - l) / 2);
                break;
            case "right":
        ...
        _buildMap: function(e, t, n, d) {
            for (var p, c, u, y, g, b, f, k, x, _, L, W = this.series,
            ...
            w = t.length; w > v; v++) {
                if (k = U.clone(t[v]), x = {
                    name: k.name,
                    path: k.path,
                    position: U.clone(k.position)
                },
                c = k.name, u = n[c]) {
                    g = [u],
                    p = "";
                    for (var I = 0,
                    J = u.seriesIndex.length; J > I; I++) g.push(W[u.seriesIndex[I]]),
                    p += W[u.seriesIndex[I]].name + " ",
                    X && this._showLegendSymbol[e] && X.hasColor(W[u.seriesIndex[I]].name) && this.shapeList.push(new o({
                        ...
                        style: {
                            ...
                            y: k.textY - 10,
                            r: 3,
                            color: X.getColor(W[u.seriesIndex[I]].name)
                        },
                        hoverable: !1
                    }));
                    y = u.value
                ...
                L._style = U.clone(L.style), L.highlightStyle = U.clone(L.style), this.deepQuery(g, "itemStyle.emphasis.label.show") ? (L.highlightStyle.text = this.getLabelText(c, y, g, "emphasis"), L.highlightStyle.color = this.deepQuery(g, "itemStyle.emphasis.label.textStyle.color") || L.style.color, f = this.deepQuery(g, "itemStyle.emphasis.label.textStyle") || f, L.highlightStyle.textFont = this.getFont(f)) : L.highlightStyle.color = "rgba(0,0,0,0)", _ = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    position: U.clone(k.position),
                    style: k,
                ...
                null != k.scale && (_.scale = U.clone(k.scale)), L = new i(L), _.style.shapeType) {
                case "rectangle":
                    _ = new r(_);
                    break;
                case "line":
                ...
                default:
                    _ = new a(_),
                    _.buildPathArray && (_.style.pathArray = _.buildPathArray(_.style.path))
                } (this._selectedMode[e] && this._selected[c] || u.selected && this._selected[c] !== !1) && (L.style = L.highlightStyle, _.style = _.highlightStyle),
                L.clickable = _.clickable = this._clickable[e] && (null == u.clickable || u.clickable),
                this._selectedMode[e] && (this._selected[c] = null != this._selected[c] ? this._selected[c] : u.selected, this._mapTypeMap[c] = e, (null == u.selectable || u.selectable) && (_.clickable = L.clickable = !0, _.onclick = L.onclick = this.shapeHandler.onclick)),
                this._hoverable[e] && (null == u.hoverable || u.hoverable) ? (L.hoverable = _.hoverable = !0, _.hoverConnect = L.id, L.hoverConnect = _.id) : L.hoverable = _.hoverable = !1,
                V.pack(L, {
                    name: p,
        ...
        _buildMark: function(e, t) {
            ...
            "none" == e && (n = [0, 0]);
            for (var i in t) this._seriesIndexToMapType[i] = e,
            this.markAttachStyle[i] = {
                position: n,
                _mapType: e
            },
            this.buildMark(i)
        ...
        getMarkCoord: function(e, t) {
            return t.geoCoord || y[t.name] ? this.geo2pos(this._seriesIndexToMapType[e], t.geoCoord || y[t.name]) : [0, 0]
        },
        ...
        _findMapTypeByPos: function(e, t) {
            var n, i, a, o, r;
            for (var s in this._mapDataMap) if (n = this._mapDataMap[s].transform, n && this._roamMap[s] && this._activeMapType[s] && (i = n.left, a = n.top, o = n.width, r = n.height, e >= i && i + o >= e && t >= a && a + r >= t)) return s
        },
        __onmousewheel: function(e) {
            function t(e, t) {
                for (var n = 0; e.pointList.length > n; n++) {
                    var i = e.pointList[n];
                    i[0] *= t,
                    i[1] *= t
                }
                var a = e.controlPointList;
                if (a) for (var n = 0; a.length > n; n++) {
                    var i = a[n];
                    i[0] *= t,
                    i[1] *= t
                }
            ...
            function n(e, t) {
                ...
                e.xEnd *= t,
                e.yEnd *= t,
                null != e.cpX1 && (e.cpX1 *= t, e.cpY1 *= t)
            }
            if (! (0 >= this.shapeList.length)) {
                for (var i = 0,
                a = this.shapeList.length; a > i; i++) {
                    var o = this.shapeList[i];
                ...
                d = e.mapTypeControl;
                d || (d = {},
                s = this._findMapTypeByPos(h, V), s && this._roamMap[s] && "move" != this._roamMap[s] && (d[s] = !0));
                var c = !1;
                for (s in d) if (d[s]) {
                    c = !0;
                    ...
                    if (U > 0) {
                        if (r = 1.2, null != this._scaleLimitMap[s].max && u.baseScale >= this._scaleLimitMap[s].max) continue
                    } else if (r = 1 / 1.2, null != this._scaleLimitMap[s].min && u.baseScale <= this._scaleLimitMap[s].min) continue;
                    u.baseScale *= r,
                    u.scale.x *= r,
                    u.scale.y *= r,
                    u.width = b * r,
                    u.height = f * r,
                    this._mapDataMap[s].hasRoam = !0,
                    this._mapDataMap[s].transform = u,
                    k = this.geo2pos(s, k),
                    u.left -= k[0] - (h - y),
                    u.top -= k[1] - (V - g),
                    this._mapDataMap[s].transform = u,
                    ...
                    a = this.shapeList.length; a > i; i++) {
                        ...
                        if (o._mapType == s) {
                            ...
                            case "polyline":
                                ...
                                break;
                            case "shape-bundle":
                                for (var L = 0; _.shapeList.length > L; L++) {
                                    var W = _.shapeList[L];
                                    "mark-line" == W.type ? n(W.style, r) : "polyline" == W.type && t(W.style, r)
                                }
                                break;
                            case "icon":
                            case "image":
                                k = this.geo2pos(s, o._geo),
                                _.x = _._x = k[0] - _.width / 2,
                                _.y = _._y = k[1] - _.height / 2;
                                break;
                            default:
                                k = this.geo2pos(s, o._geo),
                                _.x = k[0],
                                _.y = k[1],
                                "text" == x && (o._style.x = o.highlightStyle.x = k[0], o._style.y = o.highlightStyle.y = k[1])
                            }
                ...
                if (c) {
                    ...
                    100),
                    this.messageCenter.dispatch(m.EVENT.MAP_ROAM, e.event, {
                        type: "scale"
                    },
                    this.myChart)
                }
            ...
            if (! (0 >= this.shapeList.length)) {
                ...
                if (!t || !t.draggable) {
                    ...
                    if (o && this._roamMap[o] && "scale" != this._roamMap[o]) {
                        ...
                        this._my = a,
                        this._curMapType = o,
                        this.zr.on(d.EVENT.MOUSEUP, this._onmouseup);
                        var r = this;
                        setTimeout(function() {
                            r.zr.on(d.EVENT.MOUSEMOVE, r._onmousemove)
                        },
                        100)
                    }
                }
        ...
        __onmousemove: function(e) {
            if (this._mousedown && this._isAlive) {
                ...
                for (var o = 0,
                r = this.shapeList.length; r > o; o++) this.shapeList[o]._mapType == this._curMapType && (this.shapeList[o].position[0] = a.left, this.shapeList[o].position[1] = a.top, this.zr.modShape(this.shapeList[o].id));
                this.messageCenter.dispatch(m.EVENT.MAP_ROAM, e.event, {
                    type: "move"
                },
                this.myChart),
        ...
        __onmouseup: function(e) {
            ...
            setTimeout(function() {
                ...
                n._justMove = !1,
                n.zr.un(d.EVENT.MOUSEMOVE, n._onmousemove),
                n.zr.un(d.EVENT.MOUSEUP, n._onmouseup)
            },
            120)
        },
        __onroamcontroller: function(e) {
            ...
            var r, s;
            for (s in n) this._mapDataMap[s] && this._activeMapType[s] && (r = this._mapDataMap[s].transform, r.hasRoam = !0, r.left -= a, r.top -= i, this._mapDataMap[s].transform = r);
            for (var l = 0,
            h = this.shapeList.length; h > l; l++) s = this.shapeList[l]._mapType,
            n[s] && this._activeMapType[s] && (r = this._mapDataMap[s].transform, this.shapeList[l].position[0] = r.left, this.shapeList[l].position[1] = r.top, this.zr.modShape(this.shapeList[l].id));
            this.messageCenter.dispatch(m.EVENT.MAP_ROAM, e.event, {
                type: "move"
            },
            this.myChart),
        ...
        __ondrhoverlink: function(e) {
            for (var t, n, i = 0,
            a = this.shapeList.length; a > i; i++) t = this.shapeList[i]._mapType,
            this._hoverLinkMap[t] && this._activeMapType[t] && (n = V.get(this.shapeList[i], "value"), null != n && n >= e.valueMin && e.valueMax >= n && this.zr.addHoverShape(this.shapeList[i]))
        },
        onclick: function(e) {
            if (this.isClick && e.target && !this._justMove && "icon" != e.target.type) {
                ...
                a = t._mapType || "";
                if ("single" == this._selectedMode[a]) for (var o in this._selected) if (this._selected[o] && this._mapTypeMap[o] == a) {
                    for (var r = 0; i > r; r++) this.shapeList[r].style._name == o && this.shapeList[r]._mapType == a && (this.shapeList[r].style = this.shapeList[r]._style, this.zr.modShape(this.shapeList[r].id));
                    o != n && (this._selected[o] = !1)
                }
                this._selected[n] = !this._selected[n];
                for (var r = 0; i > r; r++) this.shapeList[r].style._name == n && this.shapeList[r]._mapType == a && (this.shapeList[r].style = this._selected[n] ? this.shapeList[r].highlightStyle: this.shapeList[r]._style, this.zr.modShape(this.shapeList[r].id));
                this.messageCenter.dispatch(m.EVENT.MAP_SELECTED, e.event, {
                ...
                var s = this;
                setTimeout(function() {
                    s.zr.trigger(d.EVENT.MOUSEMOVE, e.event)
                },
                100)
            }
        },
        ...
        getGeoByPos: function(e, t) {
            ...
            var n = [this._mapDataMap[e].transform.left, this._mapDataMap[e].transform.top];
            return t instanceof Array ? (t[0] -= n[0], t[1] -= n[1]) : (t.x -= n[0], t.y -= n[1]),
            this.pos2geo(e, t)
        },
        ...
        getPosByGeo: function(e, t) {
            ...
            return n[0] += this._mapDataMap[e].transform.left,
        ...
        onbeforDispose: function() {
            this._isAlive = !1,
            this.zr.un(d.EVENT.MOUSEWHEEL, this._onmousewheel),
            this.zr.un(d.EVENT.MOUSEDOWN, this._onmousedown),
            this.messageCenter.unbind(m.EVENT.ROAMCONTROLLER, this._onroamcontroller),
            this.messageCenter.unbind(m.EVENT.DATA_RANGE_HOVERLINK, this._ondrhoverlink)
        }
    },
    U.inherits(t, n),
...
define("zrender/shape/Path", ["require", "./Base", "./util/PathProxy", "../tool/util"],
function(e) {
    var t = e("./Base"),
    n = e("./util/PathProxy"),
    i = n.PathSegment,
    ...
    return s.prototype = {
        ...
        buildPathArray: function(e, t, n) {
            ...
            a = a.replace(/,,/g, ",");
            var r;
            for (r = 0; o.length > r; r++) a = a.replace(RegExp(o[r], "g"), "|" + o[r]);
            var s = a.split("|"),
            l = [],
            h = 0,
            m = 0;
            for (r = 1; s.length > r; r++) {
                var V = s[r],
                U = V.charAt(0);
                V = V.slice(1),
                V = V.replace(RegExp("e,-", "g"), "e-");
                var d = V.split(",");
                d.length > 0 && "" === d[0] && d.shift();
                for (var p = 0; d.length > p; p++) d[p] = parseFloat(d[p]);
                for (; d.length > 0 && !isNaN(d[0]);) {
                    ...
                    case "V":
                        ...
                        break;
                    case "C":
                        L.push(d.shift(), d.shift(), d.shift(), d.shift()),
                        h = d.shift(),
                        m = d.shift(),
                        L.push(h, m);
                        break;
                    case "c":
                        L.push(h + d.shift(), m + d.shift(), h + d.shift(), m + d.shift()),
                        h += d.shift(),
                        m += d.shift(),
                        _ = "C",
                        L.push(h, m);
                    ...
                    case "S":
                        ...
                        u = m,
                        y = l[l.length - 1],
                        "C" === y.command && (c = h + (h - y.points[2]), u = m + (m - y.points[3])),
                        L.push(c, u, d.shift(), d.shift()),
                        h = d.shift(),
                        m = d.shift(),
                        _ = "C",
                        L.push(h, m);
                    ...
                    case "s":
                        ...
                        y = l[l.length - 1],
                        "C" === y.command && (c = h + (h - y.points[2]), u = m + (m - y.points[3])),
                        L.push(c, u, h + d.shift(), m + d.shift()),
                        h += d.shift(),
                        m += d.shift(),
                        _ = "C",
                        L.push(h, m);
                        break;
                    case "Q":
                        L.push(d.shift(), d.shift()),
                        h = d.shift(),
                        m = d.shift(),
                        L.push(h, m);
                        break;
                    case "q":
                        L.push(h + d.shift(), m + d.shift()),
                        h += d.shift(),
                        m += d.shift(),
                        _ = "Q",
                        L.push(h, m);
                    ...
                    case "T":
                        ...
                        u = m,
                        y = l[l.length - 1],
                        "Q" === y.command && (c = h + (h - y.points[0]), u = m + (m - y.points[1])),
                        h = d.shift(),
                        m = d.shift(),
                        _ = "Q",
                        L.push(c, u, h, m);
                    ...
                    case "A":
                        ...
                        m = d.shift(),
                        _ = "A",
                        L = this._convertPoint(W, X, h, m, k, x, g, b, f);
                        break;
                    case "a":
                        g = d.shift(),
                        b = d.shift(),
                    ...
                    for (var K = 0,
                    v = L.length; v > K; K += 2) L[K] += t,
                    L[K + 1] += n;
                    l.push(new i(_ || U, L))
                } ("z" === U || "Z" === U) && l.push(new i("z", []))
            }
            return l
        },
        _convertPoint: function(e, t, n, i, a, s, l, h, m) {
            var V = m * (Math.PI / 180),
            U = Math.cos(V) * (e - n) / 2 + Math.sin(V) * (t - i) / 2,
            d = -1 * Math.sin(V) * (e - n) / 2 + Math.cos(V) * (t - i) / 2,
            p = U * U / (l * l) + d * d / (h * h);
            ...
            var u = c * l * d / h,
            y = c * -h * U / l,
            g = (e + n) / 2 + Math.cos(V) * u - Math.sin(V) * y,
            b = (t + i) / 2 + Math.sin(V) * u + Math.cos(V) * y,
            f = r([1, 0], [(U - u) / l, (d - y) / h]),
            k = [(U - u) / l, (d - y) / h],
            x = [( - 1 * U - u) / l, ( - 1 * d - y) / h],
            _ = r(k, x);
            return - 1 >= o(k, x) && (_ = Math.PI),
            o(k, x) >= 1 && (_ = 0),
            0 === s && _ > 0 && (_ -= 2 * Math.PI),
            1 === s && 0 > _ && (_ += 2 * Math.PI),
            [g, b, l, h, f, _, V, s]
        ...
        buildPath: function(e, t) {
            ...
            for (var o = t.pathArray,
            r = t.pointList = [], s = [], l = 0, h = o.length; h > l; l++) {
        ...
        getRect: function(e) {
            ...
            r = e.x || 0,
            s = e.y || 0,
            l = e.pathArray || this.buildPathArray(e.path), h = 0; l.length > h; h++) for (var m = l[h].points, V = 0; m.length > V; V++) 0 === V % 2 ? (n > m[V] + r && (n = m[V]), m[V] + r > i && (i = m[V])) : (a > m[V] + s && (a = m[V]), m[V] + s > o && (o = m[V]));
            var U;
            return U = n === Number.MAX_VALUE || i === Number.MIN_VALUE || a === Number.MAX_VALUE || o === Number.MIN_VALUE ? {
                x: 0,
                y: 0,
                width: 0,
                height: 0
    ...
    e("../tool/util").inherits(s, t),
    s
}),
define("zrender/shape/Ellipse", ["require", "./Base", "../tool/util"],
function(e) {
    var t = e("./Base"),
    n = function(e) {
        t.call(this, e)
    ...
    return n.prototype = {
        ...
        buildPath: function(e, t) {
            ...
            l = r * n;
            e.moveTo(i - o, a),
            e.bezierCurveTo(i - o, a - l, i - s, a - r, i, a - r),
            e.bezierCurveTo(i + s, a - r, i + o, a - l, i + o, a),
            e.bezierCurveTo(i + o, a + l, i + s, a + r, i, a + r),
            e.bezierCurveTo(i - s, a + r, i - o, a + l, i - o, a),
            e.closePath()
        },
...
define("echarts/component/dataRange", ["require", "./base", "zrender/shape/Text", "zrender/shape/Rectangle", "../util/shape/HandlePolygon", "../config", "zrender/tool/util", "zrender/tool/event", "zrender/tool/area", "zrender/tool/color", "../component"],
function(e) {
    function t(e, t, i, a, o) {
        if (this.query(a, "dataRange.min") === void 0 || this.query(a, "dataRange.max") === void 0) return console.error("option.dataRange.min or option.dataRange.max has not been defined."),
        void 0;
        n.call(this, e, t, i, a, o);
        var s = this;
        ...
        this._range = {},
        this.refresh(a),
        t.bind(r.EVENT.HOVER, this._onhoverlink)
    }
    var n = e("./base"),
    i = e("zrender/shape/Text"),
    ...
    return t.prototype = {
        ...
        _textGap: 10,
        _buildShape: function() {
            if (this._itemGroupLocation = this._getItemGroupLocation(), this._buildBackground(), 0 >= this.dataRangeOption.splitNumber || this.dataRangeOption.calculable ? this._buildGradient() : this._buildItem(), this.dataRangeOption.show) for (var e = 0,
            t = this.shapeList.length; t > e; e++) this.zr.addShape(this.shapeList[e]);
            this._syncShapeFromRange()
        },
        _buildItem: function() {
            var e, t, n, o, r = this._valueTextList,
            s = r.length,
            ...
            var u = !0;
            this.dataRangeOption.text && (u = !1, this.dataRangeOption.text[0] && (n = this._getTextShape(m, V, this.dataRangeOption.text[0]), "horizontal" == this.dataRangeOption.orient ? m += h.getTextWidth(this.dataRangeOption.text[0], l) + this._textGap: (V += c + this._textGap, n.style.y += c / 2 + this._textGap, n.style.textBaseline = "bottom"), this.shapeList.push(new i(n))));
            for (var y = 0; s > y; y++) e = r[y],
            o = this.getColorByIndex(y),
            t = this._getItemShape(m, V, U, d, this._selectedMap[y] ? o: "#ccc"),
            t._idx = y,
            t.onmousemove = this._dispatchHoverLink,
            this.dataRangeOption.selectedMode && (t.clickable = !0, t.onclick = this._dataRangeSelected),
            ...
            "vertical" == this.dataRangeOption.orient && "right" == this.dataRangeOption.x && (n.style.x -= U + 10, n.style.textAlign = "right"), n._idx = y, n.onmousemove = this._dispatchHoverLink, this.dataRangeOption.selectedMode && (n.clickable = !0, n.onclick = this._dataRangeSelected), this.shapeList.push(new i(n))),
            "horizontal" == this.dataRangeOption.orient ? m += U + (u ? 5 : 0) + (u ? h.getTextWidth(e, l) : 0) + p: V += d + p; ! u && this.dataRangeOption.text[1] && ("horizontal" == this.dataRangeOption.orient ? m = m - p + this._textGap: V = V - p + this._textGap, n = this._getTextShape(m, V, this.dataRangeOption.text[1]), "horizontal" != this.dataRangeOption.orient && (n.style.y -= 5, n.style.textBaseline = "top"), this.shapeList.push(new i(n)))
        },
        _buildGradient: function() {
            var t, n, o = this.getFont(this.dataRangeOption.textStyle),
            ...
            U = 10,
            d = !0;
            this.dataRangeOption.text && (d = !1, this.dataRangeOption.text[0] && (n = this._getTextShape(r, s, this.dataRangeOption.text[0]), "horizontal" == this.dataRangeOption.orient ? r += h.getTextWidth(this.dataRangeOption.text[0], o) + this._textGap: (s += V + this._textGap, n.style.y += V / 2 + this._textGap, n.style.textBaseline = "bottom"), this.shapeList.push(new i(n))));
            ...
            this.dataRangeOption.calculable && (this._buildFiller(), this._bulidMask(), this._bulidHandle()),
            this._buildIndicator(),
            !d && this.dataRangeOption.text[1] && (n = this._getTextShape(r, s, this.dataRangeOption.text[1]), this.shapeList.push(new i(n)))
        },
        _buildIndicator: function() {
            var e, t, n = this._calculableLocation.x,
            i = this._calculableLocation.y,
            a = this._calculableLocation.width,
            r = this._calculableLocation.height,
            s = 5;
            "horizontal" == this.dataRangeOption.orient ? "bottom" != this.dataRangeOption.y ? (e = [[n, i + r], [n - s, i + r + s], [n + s, i + r + s]], t = "bottom") : (e = [[n, i], [n - s, i - s], [n + s, i - s]], t = "top") : "right" != this.dataRangeOption.x ? (e = [[n + a, i], [n + a + s, i - s], [n + a + s, i + s]], t = "right") : (e = [[n, i], [n - s, i - s], [n - s, i + s]], t = "left"),
        ...
        _bulidHandle: function() {
            var e, t, n, i, a, r, s, l, m = this._calculableLocation.x,
            ...
            "horizontal" == this.dataRangeOption.orient ? "bottom" != this.dataRangeOption.y ? (e = [[m, V], [m, V + d + c], [m - c, V + d + c], [m - 1, V + d], [m - 1, V]], t = m - u / 2 - c, n = V + d + c / 2 + 2, i = {
                x: m - u - c,
                y: V + d,
                width: u + c,
                height: c
            },
            a = [[m + U, V], [m + U, V + d + c], [m + U + c, V + d + c], [m + U + 1, V + d], [m + U + 1, V]], r = m + U + u / 2 + c, s = n, l = {
                x: m + U,
                y: V + d,
                width: u + c,
                height: c
            }) : (e = [[m, V + d], [m, V - c], [m - c, V - c], [m - 1, V], [m - 1, V + d]], t = m - u / 2 - c, n = V - c / 2 - 2, i = {
                x: m - u - c,
                y: V - c,
                width: u + c,
                height: c
            },
            a = [[m + U, V + d], [m + U, V - c], [m + U + c, V - c], [m + U + 1, V], [m + U + 1, V + d]], r = m + U + u / 2 + c, s = n, l = {
                x: m + U,
                y: V - c,
                width: u + c,
                height: c
            }) : (u += c, "right" != this.dataRangeOption.x ? (e = [[m, V], [m + U + c, V], [m + U + c, V - c], [m + U, V - 1], [m, V - 1]], t = m + U + u / 2 + c / 2, n = V - c / 2, i = {
                x: m + U,
                y: V - c,
                width: u + c,
                height: c
            },
            a = [[m, V + d], [m + U + c, V + d], [m + U + c, V + c + d], [m + U, V + 1 + d], [m, V + d + 1]], r = t, s = V + d + c / 2, l = {
                x: m + U,
                y: V + d,
                width: u + c,
                height: c
            }) : (e = [[m + U, V], [m - c, V], [m - c, V - c], [m, V - 1], [m + U, V - 1]], t = m - u / 2 - c / 2, n = V - c / 2, i = {
                x: m - u - c,
                y: V - c,
                width: u + c,
                height: c
            },
            a = [[m + U, V + d], [m - c, V + d], [m - c, V + c + d], [m, V + 1 + d], [m + U, V + d + 1]], r = t, s = V + d + c / 2, l = {
                x: m - u - c,
                y: V + d,
                width: u + c,
                height: c
        ...
        _getItemGroupLocation: function() {
            ...
            if ("horizontal" == this.dataRangeOption.orient) {
                if (this.dataRangeOption.text || 0 >= this.dataRangeOption.splitNumber || this.dataRangeOption.calculable) o = (0 >= this.dataRangeOption.splitNumber || this.dataRangeOption.calculable ? i * m + n: t * (i + n)) + (this.dataRangeOption.text && this.dataRangeOption.text[0] !== void 0 ? h.getTextWidth(this.dataRangeOption.text[0], s) + this._textGap: 0) + (this.dataRangeOption.text && this.dataRangeOption.text[1] !== void 0 ? h.getTextWidth(this.dataRangeOption.text[1], s) + this._textGap: 0);
                else {
                    i += 5;
                    for (var V = 0; t > V; V++) o += i + h.getTextWidth(e[V], s) + n
                }
                o -= n,
                r = Math.max(l, a)
            } else {
                var U;
                if (this.dataRangeOption.text || 0 >= this.dataRangeOption.splitNumber || this.dataRangeOption.calculable) r = (0 >= this.dataRangeOption.splitNumber || this.dataRangeOption.calculable ? a * m + n: t * (a + n)) + (this.dataRangeOption.text && this.dataRangeOption.text[0] !== void 0 ? this._textGap + l: 0) + (this.dataRangeOption.text && this.dataRangeOption.text[1] !== void 0 ? this._textGap + l: 0),
                U = Math.max(h.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[0] || "", s), h.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[1] || "", s)),
                o = Math.max(i, U);
                else {
                    r = (a + n) * t,
                    i += 5,
            ...
            case "right":
                ...
                break;
            default:
                d = this.parsePercent(this.dataRangeOption.x, c),
                d = isNaN(d) ? 0 : d
            }
        ...
        __ondrift: function(e, t, n) {
            ...
            r = this._calculableLocation.height;
            return "horizontal" == this.dataRangeOption.orient ? i >= e.style.x + t ? e.style.x = i: e.style.x + t + e.style.width >= i + o ? e.style.x = i + o - e.style.width: e.style.x += t: a >= e.style.y + n ? e.style.y = a: e.style.y + n + e.style.height >= a + r ? e.style.y = a + r - e.style.height: e.style.y += n,
        ...
        _syncShapeFromRange: function() {
            ...
            if (this._range.end = this._range.end !== void 0 ? this._range.end: e.start !== void 0 ? e.start: 0, this._range.start = this._range.start !== void 0 ? this._range.start: e.end !== void 0 ? e.end: 100, 100 != this._range.start || 0 !== this._range.end) {
                if ("horizontal" == this.dataRangeOption.orient) {
                    var t = this._fillerShape.style.width;
                    this._fillerShape.style.x += t * (100 - this._range.start) / 100,
                    this._fillerShape.style.width = t * (this._range.start - this._range.end) / 100
                } else {
                    var n = this._fillerShape.style.height;
                    this._fillerShape.style.y += n * (100 - this._range.start) / 100,
                    this._fillerShape.style.height = n * (this._range.start - this._range.end) / 100
                }
        ...
        __dataRangeSelected: function(e) {
            ...
            var i = (this._colorList.length - n) * this._gap + this.dataRangeOption.min;
            this.messageCenter.dispatch(r.EVENT.DATA_RANGE_SELECTED, e.event, {
            ...
            this.myChart),
            this.messageCenter.dispatch(r.EVENT.REFRESH, null, null, this.myChart)
        },
        __dispatchHoverLink: function(e) {
            var t, n;
            if (this.dataRangeOption.calculable) {
                var i, a = this.dataRangeOption.max - this.dataRangeOption.min;
                i = "horizontal" == this.dataRangeOption.orient ? (1 - (l.getX(e.event) - this._calculableLocation.x) / this._calculableLocation.width) * a: (1 - (l.getY(e.event) - this._calculableLocation.y) / this._calculableLocation.height) * a,
                t = i - .05 * a,
                n = i + .05 * a
            } else {
                var o = e.target._idx;
                n = (this._colorList.length - o) * this._gap + this.dataRangeOption.min,
                t = n - this._gap
            }
        ...
        __onhoverlink: function(e) {
            if (this.dataRangeOption.show && this.dataRangeOption.hoverLink && this._indicatorShape && e && null != e.seriesIndex && null != e.dataIndex) {
                var t = e.value;
                if ("" === t || isNaN(t)) return;
                this.dataRangeOption.min > t ? t = this.dataRangeOption.min: t > this.dataRangeOption.max && (t = this.dataRangeOption.max),
                this._indicatorShape.position = "horizontal" == this.dataRangeOption.orient ? [(this.dataRangeOption.max - t) / (this.dataRangeOption.max - this.dataRangeOption.min) * this._calculableLocation.width, 0] : [0, (this.dataRangeOption.max - t) / (this.dataRangeOption.max - this.dataRangeOption.min) * this._calculableLocation.height],
        ...
        _textFormat: function(e, t) {
            if (e = ( + e).toFixed(this.dataRangeOption.precision), t = null != t ? ( + t).toFixed(this.dataRangeOption.precision) : "", this.dataRangeOption.formatter) {
        ...
        refresh: function(e) {
            if (e) {
                ...
                var t = 0 >= this.dataRangeOption.splitNumber || this.dataRangeOption.calculable ? 100 : this.dataRangeOption.splitNumber;
                if (this._colorList = m.getGradientColors(this.dataRangeOption.color, Math.max((t - this.dataRangeOption.color.length) / (this.dataRangeOption.color.length - 1), 0) + 1), this._colorList.length > t) {
                    for (var n = this._colorList.length,
                    i = [this._colorList[0]], a = n / (t - 1), o = 1; t - 1 > o; o++) i.push(this._colorList[Math.floor(o * a)]);
                    i.push(this._colorList[n - 1]),
                    this._colorList = i
                }
                var r = this.dataRangeOption.precision;
                for (this._gap = (this.dataRangeOption.max - this.dataRangeOption.min) / t; this._gap.toFixed(r) - 0 != this._gap && 5 > r;) r++;
                this.dataRangeOption.precision = r,
                this._gap = ((this.dataRangeOption.max - this.dataRangeOption.min) / t).toFixed(r) - 0,
                this._valueTextList = [];
                for (var o = 0; t > o; o++) this._selectedMap[o] = !0,
                this._valueTextList.unshift(this._textFormat(o * this._gap + this.dataRangeOption.min, (o + 1) * this._gap + this.dataRangeOption.min))
            }
            this.clear(),
            this._buildShape()
        },
        getColor: function(e) {
            ...
            if (this.dataRangeOption.min > e ? e = this.dataRangeOption.min: e > this.dataRangeOption.max && (e = this.dataRangeOption.max), this.dataRangeOption.calculable && (e - (this._gap * this._range.start + this.dataRangeOption.min) > 5e-5 || -5e-5 > e - (this._gap * this._range.end + this.dataRangeOption.min))) return null;
            ...
            return t == this._colorList.length && t--,
            this._selectedMap[t] ? this._colorList[t] : null
        },
        getColorByIndex: function(e) {
            return e >= this._colorList.length ? e = this._colorList.length - 1 : 0 > e && (e = 0),
            this._colorList[e]
        },
        onbeforDispose: function() {
...
define("echarts/component/roamController", ["require", "./base", "zrender/shape/Rectangle", "zrender/shape/Sector", "zrender/shape/Circle", "../config", "zrender/tool/util", "zrender/tool/color", "zrender/tool/event", "../component"],
function(e) {
    function t(e, t, i, a, o) {
        if (a.roamController && a.roamController.show) {
            if (!a.roamController.mapTypeControl) return console.error("option.roamController.mapTypeControl has not been defined."),
            void 0;
            n.call(this, e, t, i, a, o),
            this.rcOption = a.roamController;
            var r = this;
    ...
    return t.prototype = {
        ...
        _getScaleShape: function(e) {
            ...
            r = this._itemGroupLocation.y + this._itemGroupLocation.height - i,
            s = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
            ...
            return s = new o(s),
            s._roamType = e,
            s.onmousedown = this._scaleHandler,
            s
        },
        _buildBackground: function() {
        ...
        _getItemGroupLocation: function() {
            ...
            case "top":
                ...
                break;
            case "bottom":
                r = o - i - t[0] - t[2] - 2 * this.rcOption.borderWidth;
                break;
            case "center":
                r = Math.floor((o - i) / 2);
                break;
        ...
        refresh: function(e) {
            e && (this.option = e || this.option, this.option.roamController = this.reformOption(this.option.roamController), this.rcOption = this.option.roamController),
            this.clear(),
            this._buildShape()
        }
    },
...
define("echarts/util/mapData/params", ["require"],
function(e) {
    function t(e) {
        if (!e.UTF8Encoding) return e;
        for (var t = e.features,
        i = 0; t.length > i; i++) for (var a = t[i], o = a.geometry.coordinates, r = a.geometry.encodeOffsets, s = 0; o.length > s; s++) {
            var l = o[s];
            if ("Polygon" === a.geometry.type) o[s] = n(l, r[s]);
            else if ("MultiPolygon" === a.geometry.type) for (var h = 0; l.length > h; h++) {
                var m = l[h];
                l[h] = n(m, r[s][h])
            }
        }
        return e.UTF8Encoding = !1,
        e
    }
    function n(e, t) {
        for (var n = [], i = t[0], a = t[1], o = 0; e.length > o; o += 2) {
    ...
    var i = {
        ...
        "南海诸岛": {
            ...
            getPath: function(e, t) {
                for (var n = [[[0, 3.5], [7, 11.2], [15, 11.9], [30, 7], [42, .7], [52, .7], [56, 7.7], [59, .7], [64, .7], [64, 0], [5, 0], [0, 3.5]], [[13, 16.1], [19, 14.7], [16, 21.7], [11, 23.1], [13, 16.1]], [[12, 32.2], [14, 38.5], [15, 38.5], [13, 32.2], [12, 32.2]], [[16, 47.6], [12, 53.2], [13, 53.2], [18, 47.6], [16, 47.6]], [[6, 64.4], [8, 70], [9, 70], [8, 64.4], [6, 64.4]], [[23, 82.6], [29, 79.8], [30, 79.8], [25, 82.6], [23, 82.6]], [[37, 70.7], [43, 62.3], [44, 62.3], [39, 70.7], [37, 70.7]], [[48, 51.1], [51, 45.5], [53, 45.5], [50, 51.1], [48, 51.1]], [[51, 35], [51, 28.7], [53, 28.7], [53, 35], [51, 35]], [[52, 22.4], [55, 17.5], [56, 17.5], [53, 22.4], [52, 22.4]], [[58, 12.6], [62, 7], [63, 7], [60, 12.6], [58, 12.6]], [[0, 3.5], [0, 93.1], [64, 93.1], [64, 0], [63, 0], [63, 92.4], [1, 92.4], [1, 3.5], [0, 3.5]]], i = "", a = e[0], o = e[1], r = 0, s = n.length; s > r; r++) {
                    i += "M " + ((n[r][0][0] * t + a).toFixed(2) - 0) + " " + ((n[r][0][1] * t + o).toFixed(2) - 0) + " ";
                    for (var l = 1,
                    h = n[r].length; h > l; l++) i += "L " + ((n[r][l][0] * t + a).toFixed(2) - 0) + " " + ((n[r][l][1] * t + o).toFixed(2) - 0) + " "
                }
                return i + " Z"
            }
        },
...
define("echarts/util/mapData/geoCoord", [],
function() {
    return {
        Russia: [100, 60],
...
define("echarts/util/projection/svg", ["require", "zrender/shape/Path"],
function(e) {
    function t(e) {
    ...
    function s(e, t) {
        ...
        n && "none" != n ? (e.color = n, i ? (e.brushType = "both", e.strokeColor = i) : e.brushType = "fill") : i && "none" != i && (e.strokeColor = i, e.brushType = "stroke"),
        a && "none" != a && (e.lineWidth = parseFloat(a)),
        o && "none" != o && (e.opacity = parseFloat(o))
    }
    function l(e) {
        for (var t = r(e).replace(/,/g, " ").split(/\s+/), n = [], i = 0; t.length > i;) {
        ...
        polygon: function(e, t) {
            ...
            if (n) {
                ...
                for (var o = 0; n.length > o; o++) {
                    var r = n[o];
                    i[0] = Math.min(r[0], i[0]),
                    i[1] = Math.min(r[1], i[1]),
                    a[0] = Math.max(r[0], a[0]),
                    a[1] = Math.max(r[1], a[1])
                }
                return {
                    shapeType: "polygon",
                    pointList: n,
...
define("echarts/util/projection/normal", [],
function() {
    function e(e, n) {
        return n = n || {},
        e.srcSize || t(e, n),
    ...
    function t(e, t) {
        ...
        r.ymin = 180,
        r.ymax = -180;
        for (var n, i, a = e.features,
        o = 0,
        s = a.length; s > o; o++) if (i = a[o], !i.properties.name || !t[i.properties.name]) switch (i.type) {
        case "Feature":
            r[i.geometry.type](i.geometry.coordinates);
            break;
        case "GeometryCollection":
            n = i.geometries;
            for (var l = 0,
            h = n.length; h > l; l++) r[n[l].type](n[l].coordinates)
        }
        return e.srcSize = {
    ...
    function n(e, n, i) {
        function a(e, t) {
            ...
            m.push({
                path: y,
                cp: t.properties.cp ? o.makePoint(t.properties.cp) : o.makePoint([(o._bbox.xmin + o._bbox.xmax) / 2, (o._bbox.ymin + o._bbox.ymax) / 2]),
        ...
        o.scale = n.scale,
        o.offset = n.offset;
        for (var r, s, l, h = e.features,
        m = [], V = 0, U = h.length; U > V; V++) if (l = h[V], !l.properties.name || !i[l.properties.name]) if ("Feature" == l.type) a(l.geometry, l);
        else if ("GeometryCollection" == l.type) {
            r = l.geometries;
            for (var d = 0,
            p = r.length; p > d; d++) s = r[d],
            a(s, s)
        }
        var c, u, y;
        return m
    ...
    function i(e, t) {
        var n, i;
        return t instanceof Array ? (n = 1 * t[0], i = 1 * t[1]) : (n = 1 * t.x, i = 1 * t.y),
    ...
    function a(e, t) {
        return o.offset = e.offset,
        o.scale = e.scale,
        t instanceof Array ? o.makePoint([1 * t[0], 1 * t[1]]) : o.makePoint([1 * t.x, 1 * t.y])
    }
    var o = {
        formatPoint: function(e) {
            return [( - 168.5 > e[0] && e[1] > 63.8 ? e[0] + 360 : e[0]) + 168.5, 90 - e[1]]
        },
        ...
        Point: function(e) {
            return e = this.makePoint(e),
            e.join(",")
        },
        LineString: function(e) {
            for (var t, n = "",
            i = 0,
            a = e.length; a > i; i++) t = o.makePoint(e[i]),
        ...
        Polygon: function(e) {
            for (var t = "",
            n = 0,
            i = e.length; i > n; n++) t = t + o.LineString(e[n]) + "z";
            return t
        },
        MultiPoint: function(e) {
            for (var t = [], n = 0, i = e.length; i > n; n++) t.push(o.Point(e[n]));
            return t
        },
        MultiLineString: function(e) {
            for (var t = "",
            n = 0,
            i = e.length; i > n; n++) t += o.LineString(e[n]);
            return t
        },
        MultiPolygon: function(e) {
            for (var t = "",
            n = 0,
            i = e.length; i > n; n++) t += o.Polygon(e[n]);
            return t
        }
    },
    r = {
        ...
        LineString: function(e) {
            for (var t = 0,
            n = e.length; n > t; t++) this.makePoint(e[t])
        },
        Polygon: function(e) {
            for (var t = 0,
            n = e.length; n > t; t++) this.LineString(e[t])
        },
        MultiPoint: function(e) {
            for (var t = 0,
            n = e.length; n > t; t++) this.Point(e[t])
        },
        MultiLineString: function(e) {
            for (var t = 0,
            n = e.length; n > t; t++) this.LineString(e[t])
        ...
        MultiPolygon: function(e) {
            for (var t = 0,
            n = e.length; n > t; t++) this.Polygon(e[t])
        }
    };
    return {
        getBbox: e,
...
define("echarts/util/shape/HandlePolygon", ["require", "zrender/shape/Base", "zrender/shape/Polygon", "zrender/tool/util"],
function(e) {
    function t(e) {
        n.call(this, e)
    }
...
define("echarts/util/mapData/geoJson/an_hui_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/ao_men_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/bei_jing_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/china_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/chong_qing_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/fu_jian_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/gan_su_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/guang_dong_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/guang_xi_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/gui_zhou_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/hai_nan_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/hei_long_jiang_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/he_bei_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/he_nan_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/hu_bei_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/hu_nan_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/jiang_su_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/jiang_xi_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/ji_lin_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/liao_ning_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/nei_meng_gu_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/ning_xia_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/qing_hai_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/shang_hai_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/shan_dong_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/shan_xi_1_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/shan_xi_2_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/si_chuan_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/tai_wan_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/tian_jin_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/world_geo", [],
function() {
    return {
        type: "FeatureCollection",
        offset: {
...
define("echarts/util/mapData/geoJson/xiang_gang_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/xin_jiang_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/xi_zang_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/yun_nan_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
...
define("echarts/util/mapData/geoJson/zhe_jiang_geo", [],
function() {
    return {
        type: "FeatureCollection",
        features: [{
