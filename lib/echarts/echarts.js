var define, require, esl; (function(e) {
    function t(e) {
        c(e, F) || (O[e] = 1)
    }
    function i(e, t) {
        ...
        function(e) {
            i(e)
        }), a.length > 0) throw Error("[REQUIRE_FATAL]Relative ID is not allowed in global require: " + a.join(", "));
        var o = N.waitSeconds;
    ...
    function n() {
        ...
        if (t.length || i.length) throw Error("[MODULE_TIMEOUT]Hang( " + (t.join(", ") || "none") + " ) Miss( " + (i.join(", ") || "none") + " )")
    }
    function a(e) {
        C(B,
        function(t) {
    ...
    function o(e, t, i) {
        if (null == i && (null == t ? (i = e, e = null) : (i = t, t = null, e instanceof Array && (t = e, e = null))), null != i) {
            var n = window.opera;
            if (!e && document.attachEvent && (!n || "[object Opera]" != "" + n)) {
                var a = I();
    ...
    function l(e) {
        ...
        if (t && !c(e, M)) {
            ...
            n = t.factory,
            a = 0;
            "function" == typeof n && (a = Math.min(n.length, i.length), !t.depsDec && ("" + n).replace(/(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm, "").replace(/require\(\s*(['"'])([^'"]+)\1\s*\)/g,
            function(e, t, n) {
                i.push(n)
            }));
            var o = [],
    ...
    function d(e) {
        function t(e) {
            if (l(e), !c(e, M)) return ! 1;
            if (c(e, J) || i[e]) return ! 0;
            i[e] = 1;
            var n = z[e],
            a = !0;
            return C(n.depMs,
    ...
    function g(t, i, n) {
        ...
        C(t,
        function(e) {
            P[e] || c(e, F) || (V(e, a), (e.indexOf("!") > 0 ? f: y)(e, n))
        }),
        a()
    }
    function y(t) {
    ...
    function v(e) {
        function i(i, a) {
            if ("string" == typeof i) {
                if (!n[i]) {
                    var o = L(i, e);
                    if (p(o), !c(o, F)) throw Error('[MODULE_MISS]"' + o + '" is not exists!');
                    n[i] = z[o].exports
                }
                return n[i]
            }
    ...
    function K(e, t) {
        function i() {
            var e = n.readyState; (e === void 0 || /^(loaded|complete)$/.test(e)) && (n.onload = n.onreadystatechange = null, n = null, t())
        }
        ...
        j = n,
        tt ? et.insertBefore(n, tt) : et.appendChild(n),
        j = null
    }
    function S(e) {
        return RegExp("^" + e + "(/|$)")
    ...
    _();
    var G, Y, Z, Q, q, j, $, et = document.getElementsByTagName("head")[0],
    tt = document.getElementsByTagName("base")[0];
    tt && (et = tt.parentNode),
...
function(e) {
    ...
    s.init = function(t, n) {
        ...
        return o || (o = h++, t.setAttribute(m, o)),
        d[o] && d[o].dispose(),
        d[o] = new i(t),
        d[o].id = o,
    ...
    return i.prototype = {
        _init: function() {
            ...
            this._messageCenter.dispatch = function(e, i, n, a) {
                ...
                "HOVER" != e && "MOUSEOUT" != e ? setTimeout(function() {
            ...
            this._toolbox = new m(this._themeConfig, this._messageCenter, i, {},
            this),
        ...
        _render: function(t) {
            if (this._mergeGlobalConifg(t), !this._noDataCheck(t)) {
                ...
                for (var s, h, d, m = ["title", "legend", "tooltip", "dataRange", "roamController", "grid", "dataZoom", "xAxis", "yAxis", "polar"], c = 0, p = m.length; p > c; c++) h = m[c],
                d = this.component[h],
                ...
                for (var u, V, U, g = {},
                c = 0,
                p = t.series.length; p > c; c++) V = t.series[c].type,
                V ? g[V] || (g[V] = !0, u = o.get(V), u ? (this.chart[V] ? (U = this.chart[V], U.refresh(t)) : U = new u(this._themeConfig, this._messageCenter, this._zr, t, this), this._chartList.push(U), this.chart[V] = U) : console.error(V + " has not been required.")) : console.error("series[" + c + "] chart type has not been defined.");
                ...
                t.renderAsImage && l ? (f ? f.src = this.getDataURL(t.renderAsImage) : (f = this.getImage(t.renderAsImage), f.id = y, f.style.position = "absolute", f.style.left = 0, f.style.top = 0, this.dom.firstChild.appendChild(f)), this.un(), this._zr.un(), this._disposeChartList(), this._zr.clear()) : f && f.parentNode.removeChild(f),
                f = null,
                this._option = t
            }
        },
        ...
        _setOption: function(e, t) {
            return this._option = !t && this._option ? o.merge(this.getOption(), o.clone(e), !0) : o.clone(e),
            this._optionRestore = o.clone(this._option),
            this._option.series && 0 !== this._option.series.length ? (this.component.dataZoom && (this._option.dataZoom || this._option.toolbox && this._option.toolbox.feature && this._option.toolbox.feature.dataZoom && this._option.toolbox.feature.dataZoom.show) && this.component.dataZoom.syncOption(this._option), this._toolbox.reset(this._option), this._render(this._option), this) : (this._zr.clear(), void 0)
        },
        getOption: function() {
            function e(e) {
        ...
        addData: function(e, t, i, n, r) {
            function s() {
                if (X._zr) {
                    X._zr.clearAnimation();
                    for (var e = 0,
                    t = L.length; t > e; e++) L[e].motionlessOnce = h.addDataAnimation && L[e].addDataAnimation;
                    X._messageCenter.dispatch(a.EVENT.REFRESH, null, {
                        option: h
                    },
                    X)
                }
            }
            for (var l = e instanceof Array ? e: [[e, t, i, n, r]], h = this.getOption(), d = this._optionRestore, m = 0, c = l.length; c > m; m++) {
                e = l[m][0],
                t = l[m][1],
                i = l[m][2],
                n = l[m][3],
                ...
                if (p) {
                    var U = p.data,
                    g = h.series[e].data;
                    if (U[u](t), g[u](t), n || (U[V](), t = g[V]()), null != r) {
                        var y, f;
                        if (p.type === a.CHART_TYPE_PIE && (y = d.legend) && (f = y.data)) {
                            var b = h.legend.data;
                            if (f[u](r), b[u](r), !n) {
                                var _ = o.indexOf(f, t.name); - 1 != _ && f.splice(_, 1),
                                _ = o.indexOf(b, t.name),
                                -1 != _ && b.splice(_, 1)
                            }
                        } else if (null != d.xAxis && null != d.yAxis) {
                            var x, k, v = p.xAxisIndex || 0; (null == d.xAxis[v].type || "category" === d.xAxis[v].type) && (x = d.xAxis[v].data, k = h.xAxis[v].data, x[u](r), k[u](r), n || (x[V](), k[V]())),
                            v = p.yAxisIndex || 0,
                            "category" === d.yAxis[v].type && (x = d.yAxis[v].data, k = h.yAxis[v].data, x[u](r), k[u](r), n || (x[V](), k[V]()))
                        }
                    }
            ...
            this._zr.clearAnimation();
            for (var L = this._chartList,
            W = 0,
            w = function() {
                W--,
                0 === W && s()
            },
            m = 0, c = L.length; c > m; m++) h.addDataAnimation && L[m].addDataAnimation && (W++, L[m].addDataAnimation(l, w));
            this.component.dataZoom && this.component.dataZoom.syncOption(h),
            this._option = h;
            var X = this;
            return h.addDataAnimation || setTimeout(s, 0),
            this
        },
        ...
        getConnectedDataURL: function(t) {
            ...
            for (var l in n) d.addShape(new m({
                style: {
                    x: n[l].left - a,
                    y: n[l].top - o,
                    image: n[l].img
...
function(e) {
    ...
    function n(e, i, n, o) {
        if (i.hasOwnProperty(n)) {
            var r = e[n];
            "object" != typeof r || U[g.call(r)] || t(r) ? !o && n in e || (e[n] = i[n]) : a(e[n], i[n], o)
        }
    }
    function a(e, t, i) {
    ...
    function r() {
        return p || (c = document.createElement("canvas"), u = c.width, V = c.height, p = c.getContext("2d")),
        p
    }
    function s(e, t) {
        var i, n = 100;
        e + y > u && (u = e + y + n, c.width = u, i = !0),
        t + f > V && (V = t + f + n, c.height = V, i = !0),
        -y > e && (y = Math.ceil( - e / n) * n, u += y, c.width = u, i = !0),
        -f > t && (f = Math.ceil( - t / n) * n, V += f, c.height = V, i = !0),
        i && p.translate(y, f)
    }
    function l() {
        return {
...
function(e) {
    "use strict";
    function t(e) {
        return e.zrenderX !== void 0 && e.zrenderX || e.offsetX !== void 0 && e.offsetX || e.layerX !== void 0 && e.layerX || e.clientX !== void 0 && e.clientX
    }
    function i(e) {
        return e.zrenderY !== void 0 && e.zrenderY || e.offsetY !== void 0 && e.offsetY || e.layerY !== void 0 && e.layerY || e.clientY !== void 0 && e.clientY
    }
    function n(e) {
        return e.zrenderDelta !== void 0 && e.zrenderDelta || e.wheelDelta !== void 0 && e.wheelDelta || e.detail !== void 0 && -e.detail
    }
...
function() {
    function e(e) {
        ...
        !m && t.android && e.match(/Kindle Fire/) && (i.silk = !0),
        U && (i.chrome = !0, i.version = U[1]),
        g && (i.firefox = !0, i.version = g[1]),
        y && (i.ie = !0, i.version = y[1]),
        f && (e.match(/Safari/) || t.ios) && (i.safari = !0),
        b && (i.webview = !0),
        y && (i.ie = !0, i.version = y[1]),
        t.tablet = !!(o || V || a && !e.match(/Mobile/) || g && e.match(/Tablet/) || y && !e.match(/Phone/) && e.match(/Touch/)),
        t.phone = !(t.tablet || t.ipod || !(a || s || l || c || p || U && e.match(/Android/) || U && e.match(/CriOS\/([\d.]+)/) || g && e.match(/Mobile/) || y && e.match(/Touch/))),
        {
            browser: i,
            os: t,
...
function(e) {
    function t(e) {
        return function() {
            for (var t = e.animatingElements,
            i = 0,
            n = t.length; n > i; i++) e.storage.mod(t[i].id); (t.length || e._needsRefreshNextFrame) && e.refresh()
        }
    }
    e("./dep/excanvas");
    var i = e("./tool/util"),
    ...
    m.prototype.addElement = function(e) {
        return this.storage.addRoot(e),
        this._needsRefreshNextFrame = !0,
        this
    },
    m.prototype.delElement = function(e) {
        return this.storage.delRoot(e),
        this._needsRefreshNextFrame = !0,
        this
    },
    m.prototype.modElement = function(e, t) {
    ...
    m.prototype.animate = function(e, t, a) {
        if ("string" == typeof e && (e = this.storage.get(e)), e) {
            ...
            if (!o) return n('Property "' + t + '" is not existed in element ' + e.id),
            void 0;
            var d = this.animatingElements;
            null == e.__animators && (e.__animators = []);
            var m = e.__animators;
            0 === m.length && d.push(e);
            var c = this.animation.animate(o, {
                loop: a
            }).done(function() {
                var t = i.indexOf(e.__animators, c);
                if (t >= 0 && m.splice(t, 1), 0 === m.length) {
                    var t = i.indexOf(d, e);
                    d.splice(t, 1)
                }
            });
    ...
    m.prototype.stopAnimation = function(e) {
        if (e.__animators) {
            for (var t = e.__animators,
            n = t.length,
            a = 0; n > a; a++) t[a].stop();
            if (n > 0) {
                var o = this.animatingElements,
                r = i.indexOf(o, e);
                r >= 0 && o.splice(r, 1)
            }
            t.length = 0
...
function(e) {
    function t(e, t, n, a, r) {
        ...
        l.shapeHandler.onmousewheel = function(e) {
            ...
            n = n > 0 ? -1 : 1,
            t.style.r -= n,
            t.style.r = 5 > t.style.r ? 5 : t.style.r;
            var a = o.get(t, "value"),
    ...
    return t.prototype = {
        ...
        add: function(e) {
            ...
            "#fff" === s.style.color && (s.style.color = e.style.strokeColor),
...
function(e) {
    ...
    return t.prototype = {
        ...
        _buildItem: function() {
            ...
            "horizontal" === s.orient ? (i = .5 > this._itemGroupLocation.y / this.zr.getHeight() ? "bottom": "top", n = .5 > this._itemGroupLocation.x / this.zr.getWidth() ? "left": "right", o = .5 > this._itemGroupLocation.y / this.zr.getHeight() ? "top": "bottom") : i = .5 > this._itemGroupLocation.x / this.zr.getWidth() ? "right": "left",
            this._iconShapeMap = {};
            for (var V = this,
            U = 0; l > U; U++) {
                switch (t = {
                ...
                "horizontal" === s.orient ? h += m + c: d += m + c
            }
        },
        ...
        __onmouseup: function() {
            if (!this._zoomShape || 10 > Math.abs(this._zoomShape.style.width) || 10 > Math.abs(this._zoomShape.style.height)) return this._zooming = !1,
            !0;
        ...
        reset: function(e, t) {
            if (t && this.clear(), this.query(e, "toolbox.show") && this.query(e, "toolbox.feature.magicType.show")) {
                ...
                (this._magicMap[m] || this._magicMap[c]) && (e.series[n].__stack = e.series[n].stack)
            }
            ...
            var s = e.dataZoom;
            if (s && s.show) {
                var h = null != s.start && s.start >= 0 && 100 >= s.start ? s.start: 0,
                d = null != s.end && s.end >= 0 && 100 >= s.end ? s.end: 100;
                h > d && (h += d, d = h - d, h -= d),
                this._zoomQueue = [{
                    start: h,
                    end: d,
        ...
        getMagicOption: function() {
            ...
            if (this._defaultMagic(s.CHART_TYPE_CHORD, s.CHART_TYPE_FORCE), this._defaultMagic(s.CHART_TYPE_PIE, s.CHART_TYPE_FUNNEL), this._magicType[m] || this._magicType[c]) for (var n = 0,
            a = this.option.series.length; a > n; n++) this._magicType[m] ? (this.option.series[n].stack = "_ECHARTS_STACK_KENER_2014_", t = m) : this._magicType[c] && (this.option.series[n].stack = null, t = c),
...
function(e) {
    ...
    return t.prototype = {
        ...
        _style: function(e) {
            ...
            e.backgroundColor && (t.push("background-Color:" + c.toHex(e.backgroundColor)), t.push("filter:alpha(opacity=70)"), t.push("background-Color:" + e.backgroundColor)),
        ...
        __tryShow: function() {
            var e, t;
            if (this._curTarget) {
                if ("island" === this._curTarget._type && this.option.tooltip.show) return this._showItemTrigger(),
                void 0;
        ...
        _findAxisTrigger: function() {
            if (!this.component.xAxis || !this.component.yAxis) return this._hidingTicket = setTimeout(this._hide, this._hideDelay),
            void 0;
            ...
            t = i[n].yAxisIndex || 0,
            this.component.xAxis.getAxis(e) && this.component.xAxis.getAxis(e).type === s.COMPONENT_TYPE_AXIS_CATEGORY ? (this._showAxisTrigger(e, t, this._getNearestDataIndex("x", this.component.xAxis.getAxis(e))), void 0) : this.component.yAxis.getAxis(t) && this.component.yAxis.getAxis(t).type === s.COMPONENT_TYPE_AXIS_CATEGORY ? (this._showAxisTrigger(e, t, this._getNearestDataIndex("y", this.component.yAxis.getAxis(t))), void 0) : (this._showAxisTrigger(e, t, -1), void 0);
        ...
        _getNearestDataIndex: function(e, t) {
            ...
            for (var h, m, c = this.component.grid.getY(), l = t.getCoordByIndex(i); l > c && (h = l, l >= a);) m = l,
            l = t.getCoordByIndex(++i);
            return 0 >= i ? i = 0 : a - h >= m - a ? i -= 1 : null == t.getNameByIndex(i) && (i -= 1),
            i
        },
        _showAxisTrigger: function(e, t, i) {
            ...
            if (V) {
                ...
                this.myChart);
                var f;
                "xAxis" == V ? (p = this.subPixelOptimize(n.getCoordByIndex(i), this._axisLineWidth), u = d.getY(this._event), f = [p, this.component.grid.getY(), p, this.component.grid.getYend()]) : (p = d.getX(this._event), u = this.subPixelOptimize(n.getCoordByIndex(i), this._axisLineWidth), f = [this.component.grid.getX(), u, this.component.grid.getXend(), u]),
                this._styleAxisPointer(h, f[0], f[1], f[2], f[3], n.getGap(), p, u)
            ...
            if (h.length > 0) {
                if (this._lastItemTriggerId = -1, this._lastDataIndex != i || this._lastSeriesIndex != m[0]) {
                    this._lastDataIndex = i,
                    this._lastSeriesIndex = m[0];
                    var b, _;
                    if ("function" == typeof a) {
                        for (var x = [], g = 0, y = h.length; y > g; g++) b = h[g].data[i],
                        ...
                        for (var g = 0,
                        y = h.length; y > g; g++) a = a.replace("{a" + g + "}", this._encodeHTML(h[g].name || "")),
                        ...
                        for (var g = 0,
                        y = h.length; y > g; g++) a += "<br/>" + this._encodeHTML(h[g].name || "") + " : ",
                        b = h[g].data[i],
                        b = this.getDataFromOption(b, "-"),
        ...
        _showPolarTrigger: function(e, t) {
            ...
            if (r.length > 0) {
                ...
                this._tDom.innerHTML = i.call(this.myChart, U, this._curTicket, this._setContent);
                    ...
                    for (var m = 0,
                    c = U.length; c > m; m++) i = i.replace("{a" + m + "}", this._encodeHTML(U[m].seriesName)),
                    i = i.replace("{b" + m + "}", this._encodeHTML(U[m].name)),
                    i = i.replace("{c" + m + "}", this.numAddCommas(U[m].value)),
                    i = i.replace("{d" + m + "}", this._encodeHTML(U[m].indicator));
                    this._tDom.innerHTML = i
                } else {
                    i = this._encodeHTML(U[0].name) + "<br/>" + this._encodeHTML(U[0].indicator) + " : " + this.numAddCommas(U[0].value);
                    for (var m = 1,
                    c = U.length; c > m; m++) i += "<br/>" + this._encodeHTML(U[m].name) + "<br/>",
        ...
        _showItemTrigger: function(e) {
            if (this._curTarget) {
                ...
                m = l.get(this._curTarget, "name"),
                c = l.get(this._curTarget, "value"),
                ...
                this._curTicket, this._setContent)) : "string" == typeof t ? (this._curTicket = 0 / 0, t = t.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"), t = t.replace("{a0}", this._encodeHTML(a.name || "")).replace("{b0}", this._encodeHTML(m)).replace("{c0}", c instanceof Array ? c: this.numAddCommas(c)), t = t.replace("{d}", "{d0}").replace("{d0}", p || ""), t = t.replace("{e}", "{e0}").replace("{e0}", l.get(this._curTarget, "special2") || ""), this._tDom.innerHTML = t) : (this._curTicket = 0 / 0, this._tDom.innerHTML = a.type === s.CHART_TYPE_RADAR && p ? this._itemFormatter.radar.call(this, a, m, c, p) : a.type === s.CHART_TYPE_EVENTRIVER ? this._itemFormatter.eventRiver.call(this, a, m, c, r) : "" + (null != a.name ? this._encodeHTML(a.name) + "<br/>": "") + ("" === m ? "": this._encodeHTML(m) + " : ") + (c instanceof Array ? c: this.numAddCommas(c))));
                var y = d.getX(this._event),
                f = d.getY(this._event);
                this.deepQuery(V, "tooltip.axisPointer.show") && this.component.grid ? this._styleAxisPointer([a], this.component.grid.getX(), f, this.component.grid.getXend(), f, 0, y, f) : this._hide(),
                n !== !1 && this.option.tooltip.showContent && (this.hasAppend || (this._tDom.style.left = this._zrWidth / 2 + "px", this._tDom.style.top = this._zrHeight / 2 + "px", this.dom.firstChild.appendChild(this._tDom), this.hasAppend = !0), this._show(i, y + 20, f - 20, U))
            }
        },
        _itemFormatter: {
            radar: function(e, t, i, n) {
                ...
                a += "" === a ? "": "<br />";
                for (var o = 0; n.length > o; o++) a += this._encodeHTML(n[o].text) + " : " + this.numAddCommas(i[o]) + "<br />";
                return a
            },
        ...
        _styleAxisPointer: function(e, t, i, n, a, o, r, s) {
            if (e.length > 0) {
                ...
                for (var p in c) c[p].color = d[p + "Style"].color,
                c[p].width = d[p + "Style"].width,
                c[p].type = d[p + "Style"].type;
                for (var u = 0,
                V = e.length; V > u; u++) l = e[u],
                h = this.query(l, "tooltip.axisPointer.type"),
                m = h || m,
                h && (c[h].color = this.query(l, "tooltip.axisPointer." + h + "Style.color") || c[h].color, c[h].width = this.query(l, "tooltip.axisPointer." + h + "Style.width") || c[h].width, c[h].type = this.query(l, "tooltip.axisPointer." + h + "Style.type") || c[h].type);
                if ("line" === m) {
                    var U = c.line.width,
                    g = t == n;
                ...
                } else "shadow" === m && ((null == c.shadow.width || "auto" === c.shadow.width || isNaN(c.shadow.width)) && (c.shadow.width = o), t === n ? 2 > Math.abs(this.component.grid.getX() - t) ? (c.shadow.width /= 2, t = n += c.shadow.width / 2) : 2 > Math.abs(this.component.grid.getXend() - t) && (c.shadow.width /= 2, t = n -= c.shadow.width / 2) : i === a && (2 > Math.abs(this.component.grid.getY() - i) ? (c.shadow.width /= 2, i = a += c.shadow.width / 2) : 2 > Math.abs(this.component.grid.getYend() - i) && (c.shadow.width /= 2, i = a -= c.shadow.width / 2)), this._axisShadowShape.style = {
                    xStart: t,
                    yStart: i,
                    xEnd: n,
                    yEnd: a,
        ...
        __onmousemove: function(e) {
            if (clearTimeout(this._hidingTicket), clearTimeout(this._showingTicket), !this._mousein || !this._enterable) {
                ...
                this._event.zrenderX = i,
                this._event.zrenderY = n,
                this._needAxisTrigger && this.component.grid && m.isInside(r, this.component.grid.getArea(), i, n) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : this._needAxisTrigger && this.component.polar && -1 != this.component.polar.isInside([i, n]) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : (!this._event.connectTrigger && this.messageCenter.dispatch(s.EVENT.TOOLTIP_OUT_GRID, this._event, null, this.myChart), this._hidingTicket = setTimeout(this._hide, this._hideDelay))
            }
        },
        ...
        showTip: function(e) {
            if (e) {
                ...
                if (null != r) {
                    ...
                    m = "axis" === this.deepQuery([r, this.option], "tooltip.trigger");
                    if (d) if (m) {
                        var c = e.dataIndex;
                        switch (d.type) {
                        ...
                        case s.CHART_TYPE_K:
                            if (null == this.component.xAxis || null == this.component.yAxis || c >= r.data.length) return;
                            var p = r.xAxisIndex || 0,
                            u = r.yAxisIndex || 0;
                        ...
                        case s.CHART_TYPE_RADAR:
                            if (null == this.component.polar || c >= r.data[0].value.length) return;
                            var V = r.polarIndex || 0,
                            U = this.component.polar.getVector(V, c, "max");
                            this._event = {
                                zrenderX: U[0],
                                zrenderY: U[1]
                            },
                            this._showPolarTrigger(V, c)
                        }
                    } else {
                        var g, y, f = d.shapeList;
                        switch (d.type) {
                        case s.CHART_TYPE_LINE:
                        case s.CHART_TYPE_BAR:
                        case s.CHART_TYPE_K:
                        case s.CHART_TYPE_SCATTER:
                            for (var c = e.dataIndex,
                            a = 0,
                            o = f.length; o > a; a++) if (null == f[a]._mark && l.get(f[a], "seriesIndex") == t && l.get(f[a], "dataIndex") == c) {
                                this._curTarget = f[a],
                                g = f[a].style.x,
                                y = d.type != s.CHART_TYPE_K ? f[a].style.y: f[a].style.y[0];
                                break
                            }
                            break;
                        case s.CHART_TYPE_RADAR:
                            for (var c = e.dataIndex,
                            a = 0,
                            o = f.length; o > a; a++) if ("polygon" === f[a].type && l.get(f[a], "seriesIndex") == t && l.get(f[a], "dataIndex") == c) {
                                this._curTarget = f[a];
                        ...
                        case s.CHART_TYPE_PIE:
                            for (var b = e.name,
                            a = 0,
                            o = f.length; o > a; a++) if ("sector" === f[a].type && l.get(f[a], "seriesIndex") == t && l.get(f[a], "name") == b) {
                                this._curTarget = f[a];
                                var _ = this._curTarget.style,
                                x = (_.startAngle + _.endAngle) / 2 * Math.PI / 180;
                                g = this._curTarget.style.x + Math.cos(x) * _.r / 1.5,
                                y = this._curTarget.style.y - Math.sin(x) * _.r / 1.5;
                                break
                            }
                            break;
                        case s.CHART_TYPE_MAP:
                            ...
                            k = r.mapType,
                            a = 0,
                            o = f.length; o > a; a++) if ("text" === f[a].type && f[a]._mapType === k && f[a].style._name === b) {
                                this._curTarget = f[a],
                        ...
                        case s.CHART_TYPE_CHORD:
                            for (var b = e.name,
                            a = 0,
                            o = f.length; o > a; a++) if ("sector" === f[a].type && l.get(f[a], "name") == b) {
                                this._curTarget = f[a];
                                var _ = this._curTarget.style,
                                x = (_.startAngle + _.endAngle) / 2 * Math.PI / 180;
                                return g = this._curTarget.style.x + Math.cos(x) * (_.r - 2),
                                y = this._curTarget.style.y - Math.sin(x) * (_.r - 2),
                                this.zr.trigger(h.EVENT.MOUSEMOVE, {
                                    zrenderX: g,
                                    zrenderY: y
                                }),
                                void 0
                        ...
                        case s.CHART_TYPE_FORCE:
                            for (var b = e.name,
                            a = 0,
                            o = f.length; o > a; a++) if ("circle" === f[a].type && l.get(f[a], "name") == b) {
                                this._curTarget = f[a],
...
function(e) {
    function t(e, t, n, a, o) {
        if (!this.query(a, "legend.data")) return console.error("option.legend.data has not been defined."),
        void 0;
        i.call(this, e, t, n, a, o);
        var r = this;
    ...
    t.prototype = {
        ...
        _buildItem: function() {
            var e, t, i, a, o, s, l, m, c = this.legendOption.data,
            p = c.length,
        ...
        _getItemGroupLocation: function() {
            ...
            c = this.zr.getWidth() - m[1] - m[3],
            p = this.zr.getHeight() - m[0] - m[2],
            u = 0,
            V = 0;
            if ("horizontal" === this.legendOption.orient) {
                ...
                for (var U = 0; t > U; U++) if ("" !== this._getName(e[U])) {
                    ...
                    o)) : r);
                    u + n + g + i > c ? (u -= i, s = Math.max(s, u), l += a + i, u = 0) : (u += n + g + i, s = Math.max(s, u - i))
                } else u -= i,
                s = Math.max(s, u),
                l += a + i,
                u = 0
            ...
            case "top":
                f = m[0] + this.legendOption.borderWidth;
                break;
            case "bottom":
                f = p - l - m[0] - m[2] - 2 * this.legendOption.borderWidth;
                break;
            case "center":
                f = Math.floor((p - l) / 2);
                break;
            default:
                f = this.parsePercent(this.legendOption.y, p)
            }
            return {
                x: y,
                y: f,
        ...
        refresh: function(e) {
            if (e) {
                ...
                if (this.legendOption.selected) for (var r in this.legendOption.selected) this._selectedMap[r] = this._selectedMap[r] !== void 0 ? this._selectedMap[r] : this.legendOption.selected[r];
                for (var s = 0,
        ...
        isSelected: function(e) {
            return this._selectedMap[e] !== void 0 ? this._selectedMap[e] : !0
        },
    ...
    var m = {
        ...
        radar: function(e, t) {
            ...
            s += r;
            for (var d = 0,
            m = i - 1; m > d; d++) e.lineTo(n + o * Math.cos(s), a + o * Math.sin(s)),
            s += r;
            e.lineTo(l, h)
        }
    };
...
function() {
    function e(e, t, i, n, a, o, r, s) {
        var l;
        return n !== void 0 && (l = null == n.value ? n: n.value),
        e._echartsData = {
            _series: t,
            _seriesIndex: i,
            _data: n,
...
function(e) {
    ...
    function h(e, t, i) {
        ...
        e = K(e),
        t = K(t);
        for (var n = [], a = (t[0] - e[0]) / i, o = (t[1] - e[1]) / i, r = (t[2] - e[2]) / i, s = (t[3] - e[3]) / i, l = 0, h = e[0], d = e[1], c = e[2], p = e[3]; i > l; l++) n[l] = m([T(Math.floor(h), [0, 255]), T(Math.floor(d), [0, 255]), T(Math.floor(c), [0, 255]), p.toFixed(4) - 0], "rgba"),
        h += a,
        d += o,
        c += r,
        p += s;
    ...
    function p(e, t) {
        ...
        t.indexOf("hsb") > -1 || t.indexOf("hsv") > -1 ? i = J(i) : t.indexOf("hsl") > -1 && (i = F(i)),
        i[3] = n,
        m(i, t)
    }
    function u(e) {
    ...
    function W(e, t) {
        ...
        e = V(e);
        for (var n = K(e), a = 0; 3 > a; a++) n[a] = 1 === i ? 0 | n[a] * (1 - t) : 0 | (255 - n[a]) * t + n[a];
        return "rgb(" + n.join(",") + ")"
    }
    function w(e) {
        if (!E(e)) return e;
    ...
    function X(e, t, i) {
        ...
        i = 1 - T(i, [0, 1]);
        for (var n = 2 * i - 1,
        a = K(u(e)), o = K(u(t)), r = a[3] - o[3], s = (( - 1 === n * r ? n: (n + r) / (1 + n * r)) + 1) / 2, l = 1 - s, h = [], d = 0; 3 > d; d++) h[d] = a[d] * s + o[d] * l;
        var c = a[3] * i + o[3] * (1 - i);
        return c = Math.max(0, Math.min(1, c)),
        1 === a[3] && 1 === o[3] ? m(h, "rgb") : (h[3] = c, m(h, "rgba"))
    }
    function I() {
    ...
    function K(e) {
        e = L(e);
        var t = e.match(R);
        if (null === t) throw Error("The color format error");
        var i, n, a, o = [];
        ...
        function(e) {
            ...
            n !== void 0 && o.push(T(parseFloat(n), [0, 1]))
        } else if (t[5] || t[6]) {
            var s = (t[5] || t[6]).split(","),
    ...
    function T(e, t) {
        return t[0] >= e ? e = t[0] : e >= t[1] && (e = t[1]),
        e
    }
    function E(e) {
    ...
    function z(e) {
        ...
        n = 255 * r;
            ...
            p = 0,
            u = 0;
            0 === l ? (c = r, p = m, u = h) : 1 === l ? (c = d, p = r, u = h) : 2 === l ? (c = h, p = r, u = m) : 3 === l ? (c = h, p = d, u = r) : 4 === l ? (c = m, p = h, u = r) : (c = r, p = h, u = d),
            t = 255 * c,
            i = 255 * p,
            n = 255 * u
        }
    ...
    function J(e) {
        ...
        i = 0;
            ...
            m = ((s - a) / 6 + l / 2) / l,
            c = ((s - o) / 6 + l / 2) / l;
            n === s ? t = c - m: a === s ? t = 1 / 3 + d - c: o === s && (t = 2 / 3 + m - d),
            0 > t && (t += 1),
            t > 1 && (t -= 1)
        }
        return t = 360 * t,
...
function(e) {
    function t(e, t, i, a, o) {
        ...
        r._setCurrentOption = function() {
            ...
            r.myChart.setOption(t, e.notMerge),
        ...
        r._onFrame = function() {
            ...
            r.timelineOption.autoPlay && (r.playTicket = setTimeout(function() {
                ...
                !r.timelineOption.loop && r.currentIndex >= r.timelineOption.data.length ? (r.currentIndex = r.timelineOption.data.length - 1, r.stop(), void 0) : (r._onFrame(), void 0)
            },
    ...
    return t.prototype = {
        ...
        _getChainPoint: function() {
            ...
            h = i.data,
            d = this._location.x,
            m = this._location.y + 3 * (this._location.height / 4),
            c = this._location.x2 - this._location.x,
            p = h.length,
            u = [];
            if (p > 1) {
                var V = c / p;
                if (V = V > 50 ? 50 : 20 > V ? 5 : V, c -= 2 * V, "number" === i.type) for (var U = 0; p > U; U++) u.push(d + V + c / (p - 1) * U);
                else {
            ...
            for (var g, y, f, b, _, x = [], U = 0; p > U; U++) d = u[U],
            g = h[U].symbol && h[U].symbol.toLowerCase() || n,
            g.match("empty") ? (g = g.replace("empty", ""), f = !0) : f = !1,
            g.match("star") && (y = g.replace("star", "") - 0 || 5, g = "star"),
            t = h[U].textStyle ? l.merge(h[U].textStyle || {},
            r) : r,
            b = t.align || "center",
            o ? (b = o > 0 ? "right": "left", _ = [o * Math.PI / 180, d, m - 5]) : _ = !1,
            x.push({
                x: d,
                n: y,
                isEmpty: f,
        ...
        _findChainIndex: function(e) {
            ...
            for (var n = 0; i - 1 > n; n++) if (e >= t[n].x && t[n + 1].x >= e) return Math.abs(e - t[n].x) < Math.abs(e - t[n + 1].x) ? n: n + 1
        },
        __onclick: function(e) {
            var t = d.getX(e.event),
            i = this._findChainIndex(t);
            return i === this.currentIndex ? !0 : (this.currentIndex = i, this.timelineOption.autoPlay && this.stop(), clearTimeout(this.playTicket), this._onFrame(), void 0)
        },
...
function(e) {
    ...
    t.prototype._start = function(e, t) {
        ...
        null != i.progress ? (e(s), h.highlightStyle.width = this.adjust(i.progress, [0, 1]) * i.effectOption.width, e(h), e(r), t(), void 0) : (h.highlightStyle.width = 0, setInterval(function() {
            e(s),
    ...
    t.prototype._start = function(e, t) {
        ...
        return setInterval(function() {
            ...
            for (var i = 0; h > i; i++) {
                ...
                0 >= n.y - c[i].animationY + n.r && (c[i].highlightStyle.y = u + n.r, c[i].highlightStyle.x = Math.ceil(Math.random() * p)),
                c[i].highlightStyle.y -= c[i].animationY,
                e(c[i])
            }
            e(r),
            t()
...
function(e) {
    ...
    t.prototype._start = function(e, t) {
        for (var i = n.merge(this.options, {
            ...
            y = "random" == l.color ? a.random() : l.color;
            m[u] = new o({
                highlightStyle: {
                    xStart: V,
                    yStart: g,
        ...
        return setInterval(function() {
            ...
            for (var i = 0; h > i; i++) {
                ...
                n.xStart >= c && (m[i].len = Math.ceil(400 * Math.random()), n.xStart = -400, n.xEnd = -400 + m[i].len, n.yStart = Math.ceil(Math.random() * p), n.yEnd = n.yStart),
                n.xStart += m[i].animationX,
                n.xEnd += m[i].animationX,
                e(m[i])
            }
            e(r),
            t()
...
function(e) {
    ...
    t.prototype._start = function(e, t) {
        ...
        for (var h = this.createTextShape(i.textStyle), d = this.createBackgroundShape(i.backgroundColor), m = s.x, c = s.y, p = s.r0 + 6, u = s.r - 6, V = s.color, U = a.lift(V, .1), g = new o({
            highlightStyle: n.clone(s)
        }), y = [], f = a.getGradientColors(["#ff6400", "#ffe100", "#97ff00"], 25), b = 15, _ = 240, x = 0; 16 > x; x++) y.push(new r({
            highlightStyle: {
                x: m,
                y: c,
                r0: p,
        ...
        _ -= b;
        _ = 360;
        for (var x = 0; 4 > x; x++) y.push(new r({
            highlightStyle: {
                x: m,
                y: c,
                r0: p,
        ...
        if (null != i.progress) {
            ...
            e(g);
            for (var x = 0; 20 > x; x++) y[x].highlightStyle.color = k > x ? y[x]._color: U,
            e(y[x]);
            return e(h),
            t(),
            void 0
        ...
        return setInterval(function() {
            ...
            k += k >= 20 ? -20 : 1,
            e(g);
            for (var i = 0; 20 > i; i++) y[i].highlightStyle.color = k > i ? y[i]._color: U,
            e(y[i]);
            e(h),
            t()
        },
...
function(e) {
    ...
    t.prototype._start = function(e, t) {
        ...
        m.x = c.x + m.r,
        m.y = s.highlightStyle.y = c.y + c.height / 2,
        s.highlightStyle.x = m.x + m.r + l;
        for (var p = this.createBackgroundShape(i.backgroundColor), u = m.n, V = m.x, U = m.y, g = m.r0, y = m.r, f = m.color, b = [], _ = Math.round(180 / u), x = 0; u > x; x++) b[x] = new r({
            highlightStyle: {
                x: V,
                y: U,
                r0: g,
...
function(e) {
    ...
    t.prototype._start = function(e, t) {
        ...
        m = a.getTextHeight(l.highlightStyle.text, l.highlightStyle.textFont),
        ...
        c.x = p.x + c.r,
        c.y = l.highlightStyle.y = p.y + p.height / 2,
        l.highlightStyle.x = c.x + c.r + h;
        ...
        y = [0, c.x, c.y];
        return V.highlightStyle.x = U.highlightStyle.x = g.highlightStyle.x = y[1],
        V.highlightStyle.y = U.highlightStyle.y = g.highlightStyle.y = y[2],
...
function() {
    return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : function() {
        ...
        function p(e) {
            var t, i, n, a, o, r;
            if (a = parseFloat(e[0]) / 360 % 360, 0 > a && a++, o = c(m(e[1]), 0, 1), r = c(m(e[2]), 0, 1), 0 == o) t = i = n = r;
            else {
        ...
        function V(e) {
            ...
            if (e += "", "#" == e.charAt(0)) t = e;
                ...
                for (var n, a = d(e), t = "#", o = 0; 3 > o; o++) n = -1 != a[o].indexOf("%") ? Math.floor(255 * m(a[o])) : +a[o],
                t += D[c(n, 0, 255)];
                i = +a[3]
            } else if (/^hsl/.test(e)) {
                var a = d(e);
        ...
        function x(e, t) {
            ...
            1 > o && (a *= o),
            t.push("<g_vml_:stroke", ' opacity="', a, '"', ' joinstyle="', e.lineJoin, '"', ' miterlimit="', e.miterLimit, '"', ' endcap="', f(e.lineCap), '"', ' weight="', o, 'px"', ' color="', n, '" />')
        }
        function k(e, t, i, n) {
            var a = e.fillStyle,
            o = e.scaleX_,
            ...
            if (a instanceof w) {
                ...
                for (var L = k.length,
                W = k[0].color, I = k[L - 1].color, K = k[0].alpha * e.globalAlpha, S = k[L - 1].alpha * e.globalAlpha, T = [], E = 0; L > E; E++) {
                    var z = k[E];
                    T.push(z.offset * c + m + " " + z.color)
                }
                t.push('<g_vml_:fill type="', a.type_, '"', ' method="none" focus="100%"', ' color="', W, '"', ' color2="', I, '"', ' colors="', T.join(","), '"', ' opacity="', S, '"', ' g_o_:opacity2="', K, '"', ' angle="', h, '"', ' focusposition="', d.x, ",", d.y, '" />')
        ...
        function v(e, t, i) {
            var n = e.m_;
            return {
                x: J * (t * n[0][0] + i * n[1][0] + n[2][0]) - F,
                y: J * (t * n[0][1] + i * n[1][1] + n[2][1]) - F
            }
        }
        function L(e) {
        ...
        M = C.sqrt,
        J = 10,
        F = J / 2; + navigator.userAgent.match(/MSIE ([\d.]+)?/)[1];
        ...
        var P = {
            ...
            init_: function(e) {
                for (var t = e.getElementsByTagName("canvas"), i = 0; t.length > i; i++) this.initElement(t[i])
            },
        ...
        Q.drawImage = function(e) {
            ...
            if (u.push(" <g_vml_:group", ' coordsize="', J * V, ",", J * U, '"', ' coordorigin="0,0"', ' style="width:', V, "px;height:", U, "px;position:absolute;"), 1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
                ...
                g = this.scaleX_,
                f = this.scaleY_;
                y.push("M11=", this.m_[0][0] / g, ",", "M12=", this.m_[1][0] / f, ",", "M21=", this.m_[0][1] / g, ",", "M22=", this.m_[1][1] / f, ",", "Dx=", T(p.x / J), ",", "Dy=", T(p.y / J), "");
                var b = p,
                _ = v(this, t + n, i),
                x = v(this, t, i + a),
                k = v(this, t + n, i + a);
                ...
                u.push("padding:0 ", T(b.x / J), "px ", T(b.y / J), "px 0;filter:progid:DXImageTransform.Microsoft.Matrix(", y.join(""), ", SizingMethod='clip');")
            } else u.push("top:", T(p.y / J), "px;left:", T(p.x / J), "px;");
            u.push(' ">'),
            (o || r) && u.push('<div style="overflow: hidden; width:', Math.ceil((n + o * n / s) * g), "px;", " height:", Math.ceil((a + r * a / l) * f), "px;", " filter:progid:DxImageTransform.Microsoft.Matrix(Dx=", -o * n / s * g, ",Dy=", -r * a / l * f, ');">'),
            u.push('<div style="width:', Math.round(g * m * n / s), "px;", " height:", Math.round(f * c * a / l), "px;", " filter:"),
            1 > this.globalAlpha && u.push(" progid:DXImageTransform.Microsoft.Alpha(opacity=" + 100 * this.globalAlpha + ")"),
        ...
        Q.stroke = function(e) {
            ...
            r = 0; this.currentPath_.length > r; r++) {
        ...
        Q.drawText_ = function(e, t, n, a, o) {
            ...
            var f = v(this, t + d.x, n + d.y);
            m.push('<g_vml_:line from="', -l, ' 0" to="', h, ' 0.05" ', ' coordsize="100 100" coordorigin="0 0"', ' filled="', !o, '" stroked="', !!o, '" style="position:absolute;width:1px;height:1px;">'),
            o ? x(this, m) : k(this, m, {
                x: -l,
                y: 0
            },
            ...
            _ = T(f.x / J) + "," + T(f.y / J);
            m.push('<g_vml_:skew on="t" matrix="', b, '" ', ' offset="', _, '" origin="', l, ' 0" />', '<g_vml_:path textpathok="true" />', '<g_vml_:textpath on="true" string="', i(e), '" style="v-text-align:', V, ";font:", i(p), '" /></g_vml_:line>'),
...
function(e) {
    var t = e("../config");
    return function() {
        if (0 !== t.debugMode) if (1 == t.debugMode) for (var e in arguments) throw Error(arguments[e]);
...
function(e) {
    ...
    u = {
        resize: function(e) {
            ...
            this._isMouseDown = 0,
            this.dispatch(m.RESIZE, e)
        },
        click: function(e) {
            e = this._zrenderEventFixed(e);
            var t = this._lastHover; (t && t.clickable || !t) && 5 > this._clickThreshold && this._dispatchAgency(t, m.CLICK, e),
            this._mousemoveHandler(e)
        },
        dblclick: function(e) {
            e = e || window.event,
            e = this._zrenderEventFixed(e);
            var t = this._lastHover; (t && t.clickable || !t) && 5 > this._clickThreshold && this._dispatchAgency(t, m.DBLCLICK, e),
            this._mousemoveHandler(e)
        },
        mousewheel: function(e) {
            ...
            this._dispatchAgency(this._lastHover, m.MOUSEWHEEL, e),
            this._mousemoveHandler(e)
        },
        mousemove: function(e) {
            if (!this.painter.isLoading()) {
                ...
                var n = "default";
                if (this._draggingTarget) this.storage.drift(this._draggingTarget.id, t, i),
                ...
                this._clickThreshold++;
                    ...
                    this.painter.eachBuildinLayer(function(e) {
                        e.panable && (n = "move", e.position[0] += t, e.position[1] += i, a = !0, e.dirty = !0)
                    }),
                ...
                this._dispatchAgency(this._lastHover, m.MOUSEMOVE, e),
        ...
        mouseout: function(e) {
            ...
            if (t != this.root) for (; t && 9 != t.nodeType;) {
                if (t == this.root) return this._mousemoveHandler(e),
                void 0;
                t = t.parentNode
            }
            ...
            this.dispatch(m.GLOBALOUT, e)
        },
        mousedown: function(e) {
            return this._clickThreshold = 0,
            2 == this._lastDownButton ? (this._lastDownButton = e.button, this._mouseDownTarget = null, void 0) : (this._lastMouseDownMoment = new Date, e = this._zrenderEventFixed(e), this._isMouseDown = 1, this._mouseDownTarget = this._lastHover, this._dispatchAgency(this._lastHover, m.MOUSEDOWN, e), this._lastDownButton = e.button, void 0)
        },
        mouseup: function(e) {
            e = this._zrenderEventFixed(e),
            this.root.style.cursor = "default",
            ...
            this._dispatchAgency(this._lastHover, m.MOUSEUP, e),
            this._processDrop(e),
            this._processDragEnd(e)
        },
        ...
        touchend: function(e) {
            ...
            var t = new Date;
            t - this._lastTouchMoment < m.touchClickDelay && (this._mobileFindFixed(e), this._clickHandler(e), t - this._lastClickMoment < m.touchClickDelay / 2 && (this._dblclickHandler(e), this._lastHover && this._lastHover.clickable && s.stop(e)), this._lastClickMoment = t),
    ...
    V.prototype._processDragStart = function(e) {
        ...
        if (this._isMouseDown && t && t.draggable && !this._draggingTarget && this._mouseDownTarget == t) {
            ...
            this._dispatchAgency(i, m.DRAGSTART, e),
    ...
    V.prototype._processDragEnd = function(e) {
        this._draggingTarget && (this._dispatchAgency(this._draggingTarget, m.DRAGEND, e), this._lastHover = null),
        this._isDragging = 0,
    ...
    return V.prototype._mobileFindFixed = function(e) {
        this._lastHover = null,
        this._mouseX = e.zrenderX,
        this._mouseY = e.zrenderY,
        this._event = e,
        this._iterateAndFindHover();
        for (var t = 0; ! this._lastHover && U.length > t; t++) {
            var i = U[t];
    ...
    V.prototype._zrenderEventFixed = function(e, t) {
        ...
        if (t) {
            ...
            a && a != this._domHover && (e.zrenderX = (e.offsetX !== void 0 ? e.offsetX: e.layerX) + a.offsetLeft, e.zrenderY = (e.offsetY !== void 0 ? e.offsetY: e.layerY) + a.offsetTop)
        }
        return e.zrenderFixed = 1,
        e
    },
    l.merge(V.prototype, c.prototype, !0),
    V
}),
...
function(e) {
    ...
    h.prototype.refresh = function(e, t) {
        ...
        this._paintList(i, t);
        for (var n = 0; this._zlevelList.length > n; n++) {
    ...
    h.prototype.insertLayer = function(e, t) {
        if (this._layers[e]) return r("ZLevel " + e + " has been used already"),
        void 0;
        if (!n(t)) return r("Layer of zlevel " + e + " is not valid"),
        void 0;
        var i = this._zlevelList.length,
        a = null,
        o = -1;
        if (i > 0 && e > this._zlevelList[0]) {
            for (o = 0; i - 1 > o && !(e > this._zlevelList[o] && this._zlevelList[o + 1] > e); o++);
    ...
    h.prototype.eachLayer = function(e, t) {
        for (var i = 0; this._zlevelList.length > i; i++) {
...
function(e) {
    ...
    o.prototype._updateAndAddShape = function(e, t) {
        if (!e.ignore) if (e.updateTransform(), "group" == e.type) {
            ...
            for (var i = 0; e._children.length > i; i++) {
                var n = e._children[i];
    ...
    o.prototype.delRoot = function(e) {
        if (e === void 0) {
            for (var t = 0; this._roots.length > t; t++) {
                var a = this._roots[t];
...
function(e) {
    ...
    function r(e, t, i, n, a, o, r, l, h) {
        var d = e.length;
        if (1 == h) for (var m = 0; d > m; m++) l[m] = s(e[m], t[m], i[m], n[m], a, o, r);
        else for (var c = e[0].length, m = 0; d > m; m++) for (var p = 0; c > p; p++) l[m][p] = s(e[m][p], t[m][p], i[m][p], n[m][p], a, o, r)
    }
    function s(e, t, i, n, a, o, r) {
        var s = .5 * (i - e),
        l = .5 * (n - t);
    ...
    return g.prototype = {
                ...
                if (U) {
                    ...
                    if (U) {
                        ...
                        for (var x = [], k = [], v = 0; U > v; v++) {
                            x.push(u[v].time / _);
                            var L = u[v].value;
                            "string" == typeof L && (L = m.toArray(L), 0 === L.length && (L[0] = L[1] = L[2] = 0, L[3] = 1), f = !0),
                            k.push(L)
                        }
                        var W, v, w, X, I, K, S, C = 0,
                        T = 0;
                        if (f) var E = [0, 0, 0, 0];
                        var z = function(e, o) {
                            if (T > o) {
                                for (W = Math.min(C + 1, U - 1), v = W; v >= 0 && !(o >= x[v]); v--);
                                v = Math.min(v, U - 2)
                            } else {
                                for (v = C; U > v && !(x[v] > o); v++);
                                v = Math.min(v - 1, U - 2)
                            ...
                            var d = x[v + 1] - x[v];
                            if (0 !== d) {
                                if (w = (o - x[v]) / d, c) if (I = k[v], X = k[0 === v ? v: v - 1], K = k[v > U - 2 ? U - 1 : v + 1], S = k[v > U - 3 ? U - 1 : v + 2], y) r(X, I, K, S, w, w * w, w * w * w, l(e, V), b);
                                else {
                                    var m;
                                    f ? (m = r(X, I, K, S, w, w * w, w * w * w, E, 1), m = h(E)) : m = s(X, I, K, S, w, w * w, w * w * w),
                                    i(e, V, m)
                                } else if (y) a(k[v], k[v + 1], w, l(e, V), b);
                                else {
                                    var m;
                                    f ? (a(k[v], k[v + 1], w, E, 1), m = h(E)) : m = n(k[v], k[v + 1], w),
                                    i(e, V, m)
                                }
                                for (v = 0; t._onframeList.length > v; v++) t._onframeList[v](e, o)
                            }
                        },
                        A = new d({
                            target: t._target,
        ...
        stop: function() {
            for (var e = 0; this._clipList.length > e; e++) {
...
function(e) {
    ...
    return n.prototype = {
        ...
        brush: function(e, i) {
            var n = this.style;
            if (i && (n = this.getHighlightStyle(n, this.highlightStyle || {})), void 0 !== n.text && n.text !== !1) {
                e.save(),
                this.doClip(e),
                this.setContext(e, n),
                this.setTransform(e),
...
function(e) {
    ...
    return i.prototype = {
        ...
        _buildRadiusPath: function(e, t) {
            ...
            var m;
            i + n > l && (m = i + n, i *= l / m, n *= l / m),
            a + o > l && (m = a + o, a *= l / m, o *= l / m),
            n + a > h && (m = n + a, n *= h / m, a *= h / m),
            i + o > h && (m = i + o, i *= h / m, o *= h / m),
            e.moveTo(r + i, s),
            e.lineTo(r + l - n, s),
...
function(e) {
    ...
    function n(e, t, i, n) {
        ...
        switch (a) {
        case "bezier-curve":
            return t.cpX2 === void 0 ? l(t.xStart, t.yStart, t.cpX1, t.cpY1, t.xEnd, t.yEnd, t.lineWidth, i, n) : s(t.xStart, t.yStart, t.cpX1, t.cpY1, t.cpX2, t.cpY2, t.xEnd, t.yEnd, t.lineWidth, i, n);
        case "line":
    ...
    function r(e, t, i, n, a, o, r) {
        ...
        if (e === i) return s / 2 >= Math.abs(o - e);
        l = (t - n) / (e - i),
        h = (e * n - i * t) / (e - i);
        var d = l * o - r + h,
        m = d * d / (l * l + 1);
    ...
    function y(e, t, i, n, a, o, r, s, l, h) {
        ...
        V = 0; d > V; V++) {
            var U = T[V],
            y = W.cubicAt(e, i, a, r, U);
            l > y || (0 > u && (u = W.cubicExtrema(t, n, o, s, E), E[1] < E[0] && u > 1 && g(), m = W.cubicAt(t, n, o, s, E[0]), u > 1 && (c = W.cubicAt(t, n, o, s, E[1]))), p += 2 == u ? E[0] > U ? t > m ? 1 : -1 : E[1] > U ? m > c ? 1 : -1 : c > s ? 1 : -1 : E[0] > U ? t > m ? 1 : -1 : m > s ? 1 : -1)
        }
        return p
    }
    function f(e, t, i, n, a, o, r, s) {
        ...
        if (h >= 0 && 1 >= h) {
            for (var d = 0,
            m = W.quadraticAt(t, n, o, h), c = 0; l > c; c++) {
                var p = W.quadraticAt(e, i, a, T[c]);
                p > r || (d += h > T[c] ? t > m ? 1 : -1 : m > o ? 1 : -1)
            }
            return d
        }
    ...
    function b(e, i, n, a, o, r, s, l) {
        ...
        c = 0; 2 > c; c++) {
            ...
            if (p + e > s) {
                ...
                d = r ? 1 : -1;
                0 > u && (u = C + u),
                (u >= a && o >= u || u + C >= a && o >= u + C) && (u > Math.PI / 2 && 1.5 * Math.PI > u && (d = -d), m += d)
            }
        }
        return m
    }
    function _(e, t, i, n, a) {
        ...
        x = 0; e.length > x; x++) {
            ...
            case "M":
                ...
                break;
            case "L":
                if (g && r(d, m, v[0], v[1], t, n, a)) return ! 0;
                _ && (o += U(d, m, v[0], v[1], n, a)),
                d = v[0],
                m = v[1];
                break;
            case "C":
                if (g && s(d, m, v[0], v[1], v[2], v[3], v[4], v[5], t, n, a)) return ! 0;
                _ && (o += y(d, m, v[0], v[1], v[2], v[3], v[4], v[5], n, a)),
                d = v[4],
                m = v[5];
                break;
            case "Q":
                if (g && l(d, m, v[0], v[1], v[2], v[3], t, n, a)) return ! 0;
                _ && (o += f(d, m, v[0], v[1], v[2], v[3], n, a)),
                d = v[2],
                m = v[3];
                break;
            case "A":
                ...
                S = Math.cos(I) * w + L,
                C = Math.sin(I) * X + W;
                V ? (V = !1, c = S, p = C) : o += U(d, m, S, C);
                var T = (n - L) * X / w + L;
                if (g && h(L, W, X, I, I + K, 1 - v[7], t, T, a)) return ! 0;
                _ && (o += b(L, W, X, I, I + K, 1 - v[7], T, a)),
                d = Math.cos(I + K) * w + L,
                m = Math.sin(I + K) * X + W;
                break;
            case "z":
                if (g && r(d, m, c, p, t, n, a)) return ! 0;
                u = !0
            }
        }
        return _ && (o += U(d, m, c, p, n, a)),
        0 !== o
    }
    function x(e, t) {
        var i = e + ":" + t;
...
function(e) {
    function t(t, n, a, o, r, s, l) {
        ...
        for (var m = 0,
        c = n.length; c > m; m++) t.fillText(n[m], a, o),
        o += d
    }
    ...
    return d.prototype.doClip = function(e) {
        if (this.__clipShapes && !n) for (var t = 0; this.__clipShapes.length > t; t++) {
    ...
    d.prototype.getHighlightStyle = function(t, i, n) {
        ...
        for (var o in i) i[o] !== void 0 && (a[o] = i[o]);
        return a
    },
    ...
    d.prototype.isCoverRect = function(e, t) {
        ...
        e >= i.x && i.x + i.width >= e && t >= i.y && i.y + i.height >= t
    },
    d.prototype.drawText = function(e, i, n) {
        if (void 0 !== i.text && i.text !== !1) {
            ...
            case "start":
            case "end":
                var c = i.pointList || [[i.xStart || 0, i.yStart || 0], [i.xEnd || 0, i.yEnd || 0]],
                p = c.length;
                if (2 > p) return;
                var u, V, U, g;
                switch (d) {
                ...
                s = V,
                l = g;
                var y = 180 * (Math.atan((U - g) / (V - u)) / Math.PI);
                0 > V - u ? y += 180 : 0 > U - g && (y += 360),
                h = 5,
                y >= 30 && 150 >= y ? (o = "center", r = "bottom", l -= h) : y > 150 && 210 > y ? (o = "right", r = "middle", s -= h) : y >= 210 && 330 >= y ? (o = "center", r = "top", l += h) : (o = "left", r = "middle", s += h);
                break;
            case "specific":
                s = i.textX || 0,
                l = i.textY || 0,
...
function(e) {
    ...
    function o(e, i, n, a, o, r) {
        ...
        if (t(m) && t(c)) if (t(l)) r[0] = 0;
            ...
            if (t(U)) {
                ...
                k = 0 > k ? -Math.pow( - k, y) : Math.pow(k, y);
                var V = ( - l - (x + k)) / (3 * s);
                V >= 0 && 1 >= V && (r[u++] = V)
            } else {
                var v = (2 * m * l - 3 * s * c) / (2 * Math.sqrt(m * m * m)),
                L = Math.acos(v) / 3,
                W = Math.sqrt(m),
                w = Math.cos(L),
                V = ( - l - 2 * W * w) / (3 * s),
    ...
    function l(e, t, i, a, o, r, s, l, h, d, m) {
        ...
        for (var x = 0; 32 > x && !(U > p); x++) {
            ...
            b[0] = n(e, i, o, s, k),
            b[1] = n(t, a, r, l, k);
            var y = V.distSquare(b, f);
            if (k >= 0 && u > y) c = k,
            u = y;
            else {
                _[0] = n(e, i, o, s, v),
                _[1] = n(t, a, r, l, v);
                var L = V.distSquare(_, f);
                1 >= v && u > L ? (c = v, u = L) : p *= .5
            }
        }
        return m && (m[0] = n(e, i, o, s, c), m[1] = n(t, a, r, l, c)),
        Math.sqrt(u)
    }
    function h(e, t, i, n) {
        var a = 1 - n;
    ...
    function u(e, t, i, n, a, o, r, s, l) {
        ...
        for (var p = 0; 1 > p; p += .05) {
            b[0] = h(e, i, a, p),
            b[1] = h(t, n, o, p);
            var u = V.distSquare(f, b);
            c > u && (d = p, c = u)
        }
        c = 1 / 0;
        for (var g = 0; 32 > g && !(U > m); g++) {
            var y = d - m,
            x = d + m;
            b[0] = h(e, i, a, y),
            b[1] = h(t, n, o, y);
            var u = V.distSquare(b, f);
            if (y >= 0 && c > u) d = y,
            c = u;
            else {
                _[0] = h(e, i, a, x),
                _[1] = h(t, n, o, x);
                var k = V.distSquare(_, f);
                1 >= x && c > k ? (d = x, c = k) : m *= .5
            }
        }
...
function(e) {
    ...
    return l.prototype = {
        ...
        transformCoordToLocal: function(e, t) {
            var i = [e, t];
            return this.needTransform && this.invTransform && n.mulVector(i, this.invTransform, i),
            i
        }
    },
    l
...
function(e) {
    ...
    o.prototype.addChildrenToStorage = function(e) {
        for (var t = 0; this._children.length > t; t++) {
...
function(e) {
    function t(e) {
        ...
        this.loop = e.loop === void 0 ? !1 : e.loop,
        this.gap = e.gap || 0,
    ...
    return t.prototype = {
        step: function(e) {
            ...
            if (! (0 > t)) {
                ...
                1 == t ? this.loop ? (this.restart(), "restart") : (this._needsRemove = !0, "destroy") : null
            }
        },
        restart: function() {
...
function() {
    var e = {
        ...
        ElasticIn: function(e) {
            var t, i = .1,
            n = .4;
            return 0 === e ? 0 : 1 === e ? 1 : (!i || 1 > i ? (i = 1, t = n / 4) : t = n * Math.asin(1 / i) / (2 * Math.PI), -(i * Math.pow(2, 10 * (e -= 1)) * Math.sin((e - t) * 2 * Math.PI / n)))
        },
        ElasticOut: function(e) {
            var t, i = .1,
            n = .4;
            return 0 === e ? 0 : 1 === e ? 1 : (!i || 1 > i ? (i = 1, t = n / 4) : t = n * Math.asin(1 / i) / (2 * Math.PI), i * Math.pow(2, -10 * e) * Math.sin((e - t) * 2 * Math.PI / n) + 1)
        },
        ElasticInOut: function(e) {
            var t, i = .1,
            n = .4;
            return 0 === e ? 0 : 1 === e ? 1 : (!i || 1 > i ? (i = 1, t = n / 4) : t = n * Math.asin(1 / i) / (2 * Math.PI), 1 > (e *= 2) ? -.5 * i * Math.pow(2, 10 * (e -= 1)) * Math.sin((e - t) * 2 * Math.PI / n) : .5 * i * Math.pow(2, -10 * (e -= 1)) * Math.sin((e - t) * 2 * Math.PI / n) + 1)
        },
        BackIn: function(e) {
            var t = 1.70158;
            return e * e * ((t + 1) * e - t)
    ...
    return i.prototype = {
        ...
        ondrop: function(e, t) {
            if (this.isDrop && e.target && !t.dragIn) {
                ...
                if ( - 1 === r) {
                    ...
                    this.type === h.CHART_TYPE_PIE && 0 > i.value && (i.value = 0);
                    for (var m = !1,
                    c = s[o].data, u = 0, V = c.length; V > u; u++) c[u].name === i.name && "-" === c[u].value && (s[o].data[u].value = i.value, m = !0); ! m && s[o].data.push(i),
        ...
        _mapData: function(e) {
            ...
            m = [], c = 0, p = 0, u = e.length; u > p; p++) {
                ...
                this.selectedMap[n] && (i = t.stack || l + e[p], null == s[i] ? (s[i] = r, m[r] = [e[p]], r++) : m[s[i]].push(e[p])),
                c = Math.max(c, t.data.length)
            }
            return {
                locationMap: m,
                maxDataLength: c
        ...
        _calculMarkMapXY: function(e, t, i) {
            ...
            s = t[a].length; s > r; r++) {
                ...
                m = e[l];
                if ("-1" != i.indexOf("x")) {
                    m["counter" + h] > 0 && (m["average" + h] = m["sum" + h] / m["counter" + h]);
                    var c = this.component.xAxis.getAxis(n[l].xAxisIndex || 0).getCoord(m["average" + h]);
                    m["averageLine" + h] = [[c, d.getYend()], [c, d.getY()]],
                    m["minLine" + h] = [[m["minX" + h], d.getYend()], [m["minX" + h], d.getY()]],
                    m["maxLine" + h] = [[m["maxX" + h], d.getYend()], [m["maxX" + h], d.getY()]],
                    m.isHorizontal = !1
                }
                if (h = "xy" == i ? 1 : "", "-1" != i.indexOf("y")) {
                    m["counter" + h] > 0 && (m["average" + h] = m["sum" + h] / m["counter" + h]);
                    var p = this.component.yAxis.getAxis(n[l].yAxisIndex || 0).getCoord(m["average" + h]);
                    m["averageLine" + h] = [[d.getX(), p], [d.getXend(), p]],
                    m["minLine" + h] = [[d.getX(), m["minY" + h]], [d.getXend(), m["minY" + h]]],
                    m["maxLine" + h] = [[d.getX(), m["maxY" + h]], [d.getXend(), m["maxY" + h]]],
                    m.isHorizontal = !0
                }
            }
        },
        addLabel: function(e, t, i, n, a) {
            ...
            if (s.show) {
                ...
                m.text = this._getLabelText(t, i, n, "emphasis"),
                m.textPosition = r.show ? e.style.textPosition: null == s.position ? "horizontal" === a ? "right": "top": s.position,
                m.textColor = h.color,
                m.textFont = this.getFont(h),
                m.textAlign = h.align,
                m.textBaseline = h.baseline
            }
            return e
        },
        ...
        _buildMarkPoint: function(e) {
            ...
            for (var l = this._markPoint(e, o), r = 0, s = l.length; s > r; r++) {
                var d = l[r];
                d.zlevel = this.getZlevelBase(),
                d.z = this.getZBase() + 1;
                for (var m in n) d[m] = U.clone(n[m]);
        ...
        _buildMarkLine: function(e) {
            ...
            if (m) {
                ...
                p = d[0];
                if (p) {
                    U.merge(c.style, p.style),
                    U.merge(c.highlightStyle = {},
                    p.highlightStyle),
                    c.style.brushType = "stroke",
                    c.zlevel = this.getZlevelBase(),
                    c.z = this.getZBase() + 1,
                    c.hoverable = !1;
                    for (var u in i) c[u] = U.clone(i[u])
                }
        ...
        _markPoint: function(e, t) {
            ...
            _ = u.length; _ > b; b++) null != u[b].x && null != u[b].y && (r = null != u[b].value ? u[b].value: "", g && (o = g.getColor(i.name)), V && (o = isNaN(r) ? o: V.getColor(r), s = [u[b], t], l = this.deepQuery(s, "itemStyle.normal.color") || o, m = this.deepQuery(s, "itemStyle.emphasis.color") || l, null == l && null == m) || (o = null == o ? this.zr.getColor(e) : o, u[b].tooltip = u[b].tooltip || t.tooltip || {
                trigger: "item"
            },
        ...
        _markLine: function() {
            ...
            return function(i, n) {
                ...
                e(n, "symbolRotate");
                for (var m = n.data,
                c = [], p = this.zr.getWidth(), u = this.zr.getHeight(), g = 0; m.length > g; g++) {
                    var y = m[g];
                    if (t(y[0]) && t(y[1])) {
                        var f = this.deepMerge(y),
                        b = [f, n],
                        _ = l,
                        ...
                        y[0].tooltip = f.tooltip || n.tooltip || {
                            trigger: "item"
                        },
                        y[0].name = y[0].name || "",
                        y[1].name = y[1].name || "",
                        y[0].value = x,
                        c.push({
                            points: [[this.parsePercent(y[0].x, p), this.parsePercent(y[0].y, u)], [this.parsePercent(y[1].x, p), this.parsePercent(y[1].y, u)]],
                            rawData: y,
                            color: _
                        })
                    }
                ...
                n.name = a.name;
                for (var w = [], g = 0, X = c.length; X > g; g++) {
                    var I = c[g],
                    K = I.rawEdge || I,
                    y = K.rawData,
                    x = null != y.value ? y.value: "",
                    S = this.getMarkLineShape(n, i, y, g, I.points, L, K.color);
                    S._mark = "line";
                    var C = this.deepMerge([y[0], y[1], n], "effect");
                    C.show && (S.effect = C, S.effect.large = n.large),
                    a.type === h.CHART_TYPE_MAP && (S._geo = [this.getMarkGeo(y[0]), this.getMarkGeo(y[1])]),
                    d.pack(S, a, i, y[0], g, y[0].name + ("" !== y[1].name ? " > " + y[1].name: ""), x),
                    w.push(S)
                }
                return w
            }
        ...
        getSymbolShape: function(e, t, i, o, r, s, l, h, m, c, p) {
            var u = [i, e],
            ...
            f = this.deepMerge(u, "itemStyle.emphasis"),
            ...
            null == _ && (_ = b + 2);
            var x = this.getItemStyleColor(y.color, t, o, i),
            k = this.getItemStyleColor(f.color, t, o, i),
            v = new a({
                style: {
                    ...
                    height: 2 * U,
                    brushType: "both",
                    color: h.match("empty") ? c: x || m,
                    strokeColor: y.borderColor || x || m,
                    lineWidth: b
                },
                highlightStyle: {
                    color: h.match("empty") ? c: k || x || m,
                    strokeColor: f.borderColor || y.borderColor || k || x || m,
                    lineWidth: _
                },
                clickable: this.deepQuery(u, "clickable")
            });
            return h.match("image") && (v.style.image = h.replace(RegExp("^image:\\/\\/"), ""), v = new n({
                style: v.style,
                highlightStyle: v.highlightStyle,
                clickable: this.deepQuery(u, "clickable")
            })),
            null != g && (v.rotation = [g * Math.PI / 180, s, l]),
            h.match("star") && (v.style.iconType = "star", v.style.n = h.replace("empty", "").replace("star", "") - 0 || 5),
            "none" === h && (v.invisible = !0, v.hoverable = !1),
            v = this.addLabel(v, e, i, r, p),
            h.match("empty") && (null == v.style.textColor && (v.style.textColor = v.style.strokeColor), null == v.highlightStyle.textColor && (v.highlightStyle.textColor = v.highlightStyle.strokeColor)),
            d.pack(v, e, t, i, o, r),
            v._x = s,
            v._y = l,
            v._dataIndex = o,
        ...
        getMarkLineShape: function(e, t, i, n, a, r, l) {
            ...
            m = [i[0].symbol || e.symbol[0], i[1].symbol || e.symbol[1]],
            c = [i[0].symbolSize || e.symbolSize[0], i[1].symbolSize || e.symbolSize[1]];
            c[0] = "function" == typeof c[0] ? c[0](h) : c[0],
            c[1] = "function" == typeof c[1] ? c[1](d) : c[1];
            ...
            y = U.lineStyle,
            f = g.width;
            null == f && (f = V.borderWidth);
            var b = y.width;
            null == b && (b = null != U.borderWidth ? U.borderWidth: f + 2);
            ...
            k = new x({
                ...
                highlightStyle: {
                    ...
                    strokeColor: y.color || g.color || U.borderColor || V.borderColor || U.color || V.color || l,
                    lineWidth: b,
        ...
        getLargeMarkPointShape: function(e, t) {
            ...
            p = d.legend,
            u = [m[0], t];
            if (p && (n = p.getColor(h.name)), !c || (a = null != m[0].value ? m[0].value: "", n = isNaN(a) ? n: c.getColor(a), o = this.deepQuery(u, "itemStyle.normal.color") || n, s = this.deepQuery(u, "itemStyle.emphasis.color") || o, null != o || null != s)) {
                n = this.deepMerge(u, "itemStyle.normal").color || n;
                var V = this.deepQuery(u, "symbol") || "circle";
                V = V.replace("empty", "").replace(/\d/g, ""),
                l = this.deepMerge([m[0], t], "effect");
        ...
        addShapeList: function() {
            ...
            l = {},
            d = {};
            if (this.option.animation && !this.option.renderAsImage && i > a.length && !this.motionlessOnce) {
                for (var m = 0,
                c = n.length; c > m; m++) t = this._getAnimationKey(n[m]),
                t.match("undefined") ? this.zr.delShape(n[m].id) : (t += n[m].type, l[t] ? this.zr.delShape(n[m].id) : l[t] = n[m]);
                for (var m = 0,
                c = a.length; c > m; m++) t = this._getAnimationKey(a[m]),
                t.match("undefined") ? this.zr.addShape(a[m]) : (t += a[m].type, d[t] = a[m]);
                ...
                this.zr.delShape(n);
                for (var m = 0,
                c = a.length; c > m; m++) this.zr.addShape(a[m])
            }
        },
        _getAnimationKey: function(e) {
            return this.type != h.CHART_TYPE_MAP ? d.get(e, "seriesIndex") + "_" + d.get(e, "dataIndex") + (e._mark ? e._mark: "") + (this.type === h.CHART_TYPE_RADAR ? d.get(e, "special") : "") : d.get(e, "seriesIndex") + "_" + d.get(e, "dataIndex") + (e._mark ? e._mark: "undefined")
        },
        _animateMod: function(e, t, i, n, a, o) {
            switch (t.type) {
            case "polyline":
            case "half-smooth-polygon":
                m.pointList(this.zr, e, t, i, n);
                break;
            case "rectangle":
                m.rectangle(this.zr, e, t, i, n);
                break;
            case "image":
            case "icon":
                m.icon(this.zr, e, t, i, n, a);
                break;
            case "candle":
                o ? this.zr.addShape(t) : m.candle(this.zr, e, t, i, n);
                break;
            case "ring":
            case "sector":
            case "circle":
                o ? "sector" === t.type ? m.sector(this.zr, e, t, i, n) : this.zr.addShape(t) : m.ring(this.zr, e, t, i + 100 * ((d.get(t, "dataIndex") || 0) % 20), n);
                break;
            case "text":
                m.text(this.zr, e, t, i, n);
                break;
            case "polygon":
                o ? m.pointList(this.zr, e, t, i, n) : m.polygon(this.zr, e, t, i, n);
                break;
            case "ribbon":
                m.ribbon(this.zr, e, t, i, n);
                break;
            case "gauge-pointer":
                m.gaugePointer(this.zr, e, t, i, n);
                break;
            case "mark-line":
                m.markline(this.zr, e, t, i, n);
                break;
            case "bezier-curve":
            case "line":
                m.line(this.zr, e, t, i, n);
                break;
            default:
                this.zr.addShape(t)
            }
        ...
        animationEffect: function(e) {
            if (!e && this.clearEffectShape(), e = e || this.shapeList, null != e) {
                ...
                i._mark && i.effect && i.effect.show && c[i._mark] && (c[i._mark](this.zr, this.effectList, i, t), this.effectList[this.effectList.length - 1]._mark = i._mark)
            }
        },
        clearEffectShape: function(e) {
            ...
            if (this.zr && t && t.length > 0) {
                ...
                this.zr.delShape(t);
                for (var i = 0; t.length > i; i++) t[i].effectAnimator && t[i].effectAnimator.stop()
            }
            this.effectList = []
        },
...
function(e) {
    ...
    function m(e, t) {
        ...
        e.arc(i + 7 * r, n + 6 * s, l, 5 * (Math.PI / 4), 4 * Math.PI),
        e.arc(i + 7 * r, n + 6 * s, l / 2, 5 * (Math.PI / 4), 4 * Math.PI),
    ...
    function c(e, t) {
        ...
        e.arc(i + r, n, r, Math.PI / 4, 4 * (Math.PI / 5)),
        e.arc(i, n + r, r, -Math.PI / 3, Math.PI / 3),
        e.arc(i + a, n + o, r, Math.PI, 3 * (Math.PI / 2)),
        e.lineWidth = 1.5
    }
    function p(e, t) {
        for (var i = t.x,
    ...
    function W(e, t) {
        var i = t.x,
        n = t.y - 1.5 * (t.height / 2),
        a = t.width / 2,
        o = t.height / 2,
        r = Math.min(a, o);
        e.arc(i + a, n + o, r, 4 * (Math.PI / 5), Math.PI / 5),
    ...
    return X.prototype = {
        ...
        getRect: function(e) {
            return e.__rect ? e.__rect: (e.__rect = {
                x: Math.round(e.x),
                y: Math.round(e.y - ("pin" == e.iconType ? 1.5 * (e.height / 2) : 0)),
                width: e.width,
        ...
        isCover: function(e, t) {
            ...
            var a = 8 > n.height || 8 > n.width ? 4 : 0;
            return e >= n.x - a && n.x + n.width + a >= e && t >= n.y - a && n.y + n.height + a >= t
        }
    },
    I.inherits(X, K),
    X
    ...
    return t.prototype = {
        ...
        brushSymbol: function(e, t, i) {
            if ("none" != t.symbol[i]) {
                ...
                if (p = p / 180 * Math.PI, "arrow" == a && 0 === p) if (0 === c) {
                    var u = 0 === i ? -1 : 1;
                    p = Math.PI / 2 + Math.atan2(u * (l - r), u * (s - o))
                } else {
                    var V = t.cpX1,
                    U = t.cpY1,
                    g = m.quadraticDerivativeAt,
                    y = g(o, V, s, i),
                    f = g(r, U, l, i);
                    p = Math.PI / 2 + Math.atan2(f, y)
                }
                e.translate(h, d),
                0 !== p && e.rotate(p);
...
function(e) {
    ...
    return t.prototype = {
        ...
        buildPath: function(e, t) {
            ...
            d = Math.ceil(n / h), m = i[0] instanceof Array, c = t.size ? t.size: 2, p = c, u = c / 2, V = 2 * Math.PI, U = 0; d > U; U++) {
                e.beginPath(),
                a = U * h,
                o = a + h,
                o = o > n ? n: o;
                for (var g = a; o > g; g++) if (t.random && (r = t["randomMap" + g % 20] / 100, p = c * r * r, u = p / 2), m ? (s = i[g][0], l = i[g][1]) : (s = i[g].x, l = i[g].y), 3 > p) e.rect(s - u, l - u, p, p);
            ...
            if (! (2 > n.length)) {
                ...
                if (t.smooth && "spline" !== t.smooth) {
                    ...
                    if ("dashed" == t.lineType || "dotted" == t.lineType) {
                        var m = (t.lineWidth || 1) * ("dashed" == t.lineType ? 5 : 1);
                        e.moveTo(n[0][0], n[0][1]);
                        for (var d = 1; o > d; d++) a(e, n[d - 1][0], n[d - 1][1], n[d][0], n[d][1], m)
                    }
                } else {
                    e.moveTo(n[0][0], n[0][1]);
...
function(e) {
    ...
    return i.prototype = {
        ...
        brush: function(e, t) {
            var i = this.beforeBrush(e, t);
            e.beginPath();
            for (var n = 0; i.shapeList.length > n; n++) {
                var a = i.shapeList[n],
                o = a.style;
        ...
        getRect: function(e) {
            ...
            n = 1 / 0,
            a = -1 / 0,
            o = 0; e.shapeList.length > o; o++) var r = e.shapeList[o],
            s = r.getRect(r.style),
            t = Math.min(s.x, t),
            n = Math.min(s.y, n),
        ...
        isCover: function(e, t) {
            var i = this.transformCoordToLocal(e, t);
            if (e = i[0], t = i[1], this.isCoverRect(e, t)) for (var n = 0; this.style.shapeList.length > n; n++) {
...
function(e) {
    function t(e, t, i, n, a) {
        ...
        o = t.style.pointList;
        var m = o.length;
        i.style.pointList = m == s ? o: s > m ? o.concat(r.slice(m)) : o.slice(0, s),
        e.addShape(i),
        i.__animating = !0,
    ...
    function n(e, t, n, a, o) {
        ...
        h = r.width,
        d = r.height,
        m = [n.position[0], n.position[1]];
        i(n, t, "x", "y", "width", "height"),
        n.position = t.position,
        e.addShape(n),
        (m[0] != t.position[0] || m[1] != t.position[1]) && e.animate(n.id, "").when(a, {
            position: m
        }).start(o),
        n.__animating = !0,
    ...
    function o(e, t, i, n, a) {
        ...
        "r" != i._animationAdd ? (i.style.r0 = 0, i.style.r = 0, i.rotation = [2 * Math.PI, o, r], e.addShape(i), e.animate(i.id, "style").when(n, {
            ...
            i.__animating = !1
        }).start(a), e.animate(i.id, "").when(Math.round(2 * (n / 3)), {
            rotation: [0, o, r]
...
function(e) {
    function t(e, t, i, n) {
        ...
        m = r.scaleSize,
        c = r.bounceDistance,
        p = r.shadowBlur !== void 0 ? r.shadowBlur: m;
        "image" !== i.type ? (a = new h({
            ...
            draggable: !1,
            hoverable: !1
        }), "pin" == i.style.iconType && (a.style.y += 1.5 * (a.style.height / 2)), u && (a.style.image = e.shapeToImage(a, a.style.width + 2 * p + 2, a.style.height + 2 * p + 2).style.image, a = new s({
            zlevel: a.zlevel,
            style: a.style,
            draggable: !1,
            hoverable: !1
        ...
        "pin" == i.style.iconType && (a.style.y -= 1.5 * (i.style.height / 2));
        var g = 100 * (r.period + 10 * Math.random());
        e.modShape(i.id, {
            invisible: !0
        });
        var y = a.style.x + a.style.width / 2 / V,
        f = a.style.y + a.style.height / 2 / V;
    ...
    function i(e, t, i, n) {
        ...
        r = a.scaleSize,
        s = a.shadowColor || o,
        l = a.shadowBlur !== void 0 ? a.shadowBlur: 2 * r,
        ...
        for (var c = Math.round(100 * a.period), p = {},
        u = {},
        V = 0; 20 > V; V++) m.style["randomMap" + V] = 0,
        p = {},
        p["randomMap" + V] = 100,
        u = {},
        u["randomMap" + V] = 0,
        m.style["randomMap" + V] = 100 * Math.random(),
        e.animate(m.id, "style", !0).when(c, p).when(2 * c, u).when(3 * c, p).when(4 * c, p).delay(Math.random() * c * V).start()
    }
    function n(e, t, i, n, a) {
        var s = i.effect,
        h = i.style,
        d = s.color || h.strokeColor || h.color,
        m = s.shadowColor || h.strokeColor || d,
        V = h.lineWidth * s.scaleSize,
        U = s.shadowBlur !== void 0 ? s.shadowBlur: V,
        g = new r({
            zlevel: n,
            style: {
                x: U,
        ...
        if (i instanceof c) {
            for (var b = [0], _ = 0, x = h.pointList, k = h.controlPointList, v = 1; x.length > v; v++) {
                if (k) {
                    var L = k[2 * (v - 1)],
                    W = k[2 * (v - 1) + 1];
            ...
            X = e.animation.animate(w, {
                loop: s.loop
            }), v = 0; b.length > v; v++) X.when(b[v] * s.period, {
                p: v
            });
            X.during(function() {
            ...
            if (i.style.curveness > 0) {
                ...
                g.effectAnimator = e.animation.animate(g, {
                    ...
                    g.style.x = l.quadraticAt(I, z, S, i),
                    g.style.y = l.quadraticAt(K, A, C, i),
                    a || e.modShape(g)
                }).done(f).start()
    ...
    function a(e, t, i, a) {
        ...
        h = [], d = 0; r.length > d; d++) {
            r[d].effect = s;
            var c = n(e, null, r[d], a, !0),
            p = c.effectAnimator;
            o.style.shapeList.push(c),
            p.duration > l && (l = p.duration),
            0 === d && (o.style.color = c.style.color, o.style.shadowBlur = c.style.shadowBlur, o.style.shadowColor = c.style.shadowColor),
            h.push(p)
        }
        t.push(o),
        e.addShape(o);
        var u = function() {
            for (var e = 0; h.length > e; e++) h[e].stop()
        };
        if (l) {
            o.__dummy = 0;
    ...
    m = e("zrender/shape/ShapeBundle"),
    c = e("zrender/shape/Polyline"),
...
function(e) {
    ...
    return t.prototype = {
        ...
        subPixelOptimize: function(e, t) {
            return e = 1 === t % 2 ? Math.floor(e) + .5 : Math.round(e)
        },
        resize: function() {
...
function(e) {
    ...
    o.prototype = {
        ...
        run: function(e) {
            ...
            function n(e, i) {
                for (var n = [], a = 0, o = 0; e.length > o; o++) a > 0 && t(e[o], n[a - 1]) || (n[a++] = c(e[o]));
                return i[0] && !t(n[0], i[0]) && (n = n.reverse()),
                n
            }
            for (var a = this._iterate(e), o = 0; o++<this.maxIteration;) {
                for (var r = [], s = 0; a.groups.length > s; s++) r.push(new i(a.groups[s]));
                var l = this._iterate(r);
                if (0 >= l.savedInk) break;
                a = l
            }
            var d = [],
            m = function(e, t) {
                for (var a, o = 0; e.length > o; o++) {
                    ...
                    if (r.edgeList[0] && r.edgeList[0].edge instanceof i) {
                        for (var s = [], l = 0; r.edgeList.length > l; l++) s.push(r.edgeList[l].edge.group);
                        a = t ? t.slice() : [],
                        a.unshift(r.mp0),
                        a.push(r.mp1),
                        m(s, a)
                    } else for (var l = 0; r.edgeList.length > l; l++) {
                        var h = r.edgeList[l];
                        a = t ? t.slice() : [],
                        a.unshift(r.mp0),
                        a.push(r.mp1),
        ...
        _iterate: function(e) {
            for (var i = [], o = [], s = 0, h = 0; e.length > h; h++) {
                var d = new n(e[h]);
                i.push(d)
            }
            for (var c = new r(i, 4), p = [], u = l(), V = l(), U = 0, g = l(), y = l(), f = 0, h = 0; i.length > h; h++) {
                var d = i[h];
                if (!d.group) {
                    c.nearestN(d, this.maxNearestEdge, t, p);
                    for (var b = 0,
                    _ = null,
                    x = null,
                    k = 0; p.length > k; k++) {
                    ...
                    if (_) {
                        ...
                        var W = new a;
                        o.push(W),
                        m(W.mp0, d.getStartPoint()),
                        m(W.mp1, d.getEndPoint()),
                        W.ink = d.ink,
                        W.addEdge(d)
                    }
                }
        ...
        _calculateGroupEdgeInk: function(e, t, i, n) {
            for (var a = [], o = [], r = 0; e.edgeList.length > r; r++) {
                var s = e.edgeList[r];
            ...
            for (var l = d(i, n), r = 0; a.length > r; r++) l += d(a[r], i) + d(o[r], n);
            return l
        },
        ...
        _limitTurningAngle: function() {
            ...
            return function(a, o, r, l) {
                var m = Math.cos(this.maxTurningAngle),
                c = Math.tan(this.maxTurningAngle);
                s.sub(e, o, r),
                s.normalize(e, e),
                s.copy(l, o);
                for (var p = 0,
    ...
    return r.prototype = {
        ...
        buildPath: function(e, t) {
            ...
            if (o && !(2 > o)) {
                ...
                u.push([c, p]);
                for (var V, U = 0,
                g = 2 * o - 1; g > U; U++) V = 0 === U % 2 ? h: l,
                u.push([r + V * n(m), s + V * i(m)]),
                m += d;
                u.push([c, p]),
                e.moveTo(u[0][0], u[0][1]);
                for (var U = 0; u.length > U; U++) e.lineTo(u[U][0], u[U][1]);
                e.closePath()
            }
        },
        getRect: function(e) {
...
function(e) {
    ...
    return n.prototype.fastBoundingRect = function() {
        ...
        e[0] = e[1] = 1 / 0,
        i[0] = i[1] = -1 / 0;
        for (var n = 0; this.pathCommands.length > n; n++) {
...
function(e) {
    ...
    return i.prototype = {
        ...
        buildPath: function(e, t) {
            ...
            t.cpX2 !== void 0 && t.cpY2 !== void 0 ? e.bezierCurveTo(t.cpX1, t.cpY1, t.cpX2, t.cpY2, t.xEnd, t.yEnd) : e.quadraticCurveTo(t.cpX1, t.cpY1, t.xEnd, t.yEnd)
        },
        getRect: function(e) {
            if (e.__rect) return e.__rect;
            ...
            o = e.cpX2,
            r = e.cpY2;
            o !== void 0 && r !== void 0 && (t = Math.min(t, o), i = Math.min(i, r), n = Math.max(n, o), a = Math.max(a, r));
            var s = e.lineWidth || 1;
            return e.__rect = {
                x: t - s,
                y: i - s,
...
function() {
    ...
    return function(t, i, n, a, o, r) {
        ...
        l /= h;
        for (var d = !0,
        m = 0; h > m; ++m) d ? t.moveTo(i, n) : t.lineTo(i, n),
        d = !d,
        i += s,
        n += l;
        t.lineTo(a, o)
...
function(e) {
    ...
    return o.prototype = {
            ...
            if (! (2 > o.length)) {
                if (t.smooth && "spline" !== t.smooth) {
                    ...
                    if ("dashed" == t.lineType || "dotted" == t.lineType) {
                        ...
                        e.moveTo(o[0][0], o[0][1]);
                        for (var m = 1,
                        p = o.length; p > m; m++) a(e, o[m - 1][0], o[m - 1][1], o[m][0], o[m][1], c);
                        a(e, o[o.length - 1][0], o[o.length - 1][1], o[0][0], o[0][1], c)
                    }
                } else {
                    e.moveTo(o[0][0], o[0][1]);
                    for (var m = 1,
                    p = o.length; p > m; m++) e.lineTo(o[m][0], o[m][1]);
        ...
        getRect: function(e) {
            ...
            o = e.pointList,
            r = 0,
            s = o.length; s > r; r++) t > o[r][0] && (t = o[r][0]),
            o[r][0] > i && (i = o[r][0]),
            n > o[r][1] && (n = o[r][1]),
            o[r][1] > a && (a = o[r][1]);
            var l;
...
function(e) {
    ...
    return function(e, n) {
        ...
        for (var s = 0; l > s; s++) {
            ...
            var U = u * u,
            g = u * U;
            o.push([t(h[0], V[0], d[0], m[0], u, U, g), t(h[1], V[1], d[1], m[1], u, U, g)])
        }
        return o
    }
}),
...
function(e) {
    ...
    function i(e, i) {
        for (var n, a = 0,
        o = e.length; o > a; a++) if (n = t(e[a], i), n !== void 0) return n
    }
    function n(e, i) {
        for (var n, o = e.length; o--;) {
            var r = t(e[o], i);
            r !== void 0 && (n === void 0 ? n = a.clone(r) : a.merge(n, r, !0))
        }
        return n
    }
...
function(e) {
    ...
    n.prototype.nearestN = function(e, t, i, n) {
        ...
        for (a.data !== e && (d++, this._addNearest(d, h, a)), e.array[a.axis] < a.data.array[a.axis] ? (a.right && (o[r++] = a.right), a.left && (o[r++] = a.left)) : (a.left && (o[r++] = a.left), a.right && (o[r++] = a.right)); r--;) {
            ...
            c = !1;
            h *= h,
            (t > d || s[d - 1].dist > h) && (h = i(a.data, e), (t > d || s[d - 1].dist > h) && a.data !== e && (t > d && d++, this._addNearest(d, h, a)), c = !0),
            m ? (c && a.right && (o[r++] = a.right), a.left && (o[r++] = a.left)) : (c && a.left && (o[r++] = a.left), a.right && (o[r++] = a.right))
        }
...
function() {
    ...
    function n(t, n, a, o, r) {
        return 3 >= arguments.length && (o = n, r = 2 == arguments.length ? e: a, n = 0, a = t.length - 1),
        i(t, n, a, o, r)
    }
    return n
}),
    ...
    return t.prototype = {
        ...
        _contentToOption: function(e) {
            ...
            if (this.option.xAxis) for (h = this.option.xAxis instanceof Array ? this.option.xAxis: [this.option.xAxis], t = 0, o = h.length; o > t; t++) if ("category" == (h[t].type || "category")) {
                ...
                r = h[t].data[i],
                h[t].data[i].value !== void 0 ? h[t].data[i].value = l: h[t].data[i] = l;
                d++
            }
            ...
            for (t = 0, o = m.length; o > t; t++) if (d++, m[t].type == n.CHART_TYPE_SCATTER) for (var i = 0,
            a = m[t].data.length; a > i; i++) s = e[d],
            l = s.replace(" ", "").split(","),
            m[t].data[i].value !== void 0 ? m[t].data[i].value = l: m[t].data[i] = l,
            d++;
            else {
                s = e[d].split(",");
                for (var i = 0,
                a = m[t].data.length; a > i; i++) l = (s[i] || "").replace(/.*:/, ""),
                l = this._trim(l),
                l = "-" != l && "" !== l ? l - 0 : "-",
                m[t].data[i].value !== void 0 ? m[t].data[i].value = l: m[t].data[i] = l;
                d++
...
function(e) {
    ...
    return h.prototype = {
        ...
        buildPath: function(e, i) {
            ...
            var d = t.cos(s),
            m = t.sin(s);
            e.moveTo(d * o + n, m * o + a),
            e.lineTo(d * r + n, m * r + a),
            e.arc(n, a, r, s, l, !h),
        ...
        getRect: function(e) {
            ...
            d = e.r0 || 0,
            m = e.r,
            c = t.degreeToRadian(e.startAngle),
            p = t.degreeToRadian(e.endAngle),
            u = e.clockWise;
            return u || (c = -c, p = -p),
            d > 1 ? i.arc(a, h, d, c, p, !u, o, s) : (o[0] = s[0] = a, o[1] = s[1] = h),
            i.arc(a, h, m, c, p, !u, r, l),
            n.min(o, o, r),
            n.max(s, s, l),
            e.__rect = {
                x: o[0],
...
function(e) {
    function t(e, t, i) {
        if (0 !== e.length) {
            for (var n = e[0][0], a = e[0][0], o = e[0][1], r = e[0][1], s = 1; e.length > s; s++) {
                var l = e[s];
                n > l[0] && (n = l[0]),
                l[0] > a && (a = l[0]),
                o > l[1] && (o = l[1]),
    ...
    function i(e, t, i, n, a, r) {
        ...
        for (var l = 0; s.length > l; l++) s[l] = o.cubicAt(e[0], t[0], i[0], n[0], s[l]);
        var h = [];
        o.cubicExtrema(e[1], t[1], i[1], n[1], h);
        for (var l = 0; h.length > l; l++) h[l] = o.cubicAt(e[1], t[1], i[1], n[1], h[l]);
        s.push(e[0], n[0]),
        h.push(e[1], n[1]);
        var d = Math.min.apply(null, s),
        m = Math.max.apply(null, s),
        c = Math.min.apply(null, h),
    ...
    function n(e, t, i, n, a) {
        ...
        m = l * l * e[1] + 2 * l * r * t[1] + r * r * i[1],
        c = h * h * e[0] + 2 * h * s * t[0] + s * s * i[0],
        p = h * h * e[1] + 2 * h * s * t[1] + s * s * i[1];
        n[0] = Math.min(e[0], i[0], d, c),
        n[1] = Math.min(e[1], i[1], m, p),
        a[0] = Math.max(e[0], i[0], d, c),
        a[1] = Math.max(e[1], i[1], m, p)
    }
    var a = e("./vector"),
    o = e("./curve"),
    r = a.create(),
...
function(e) {
    ...
    return t.prototype = {
        ...
        isCover: function(e, t) {
            var i = this.style;
            return e >= i.x && i.x + i.width >= e && t >= i.y && i.y + i.height >= t ? !0 : !1
        }
    },
    o.inherits(t, i),
    t
...
function(e) {
    ...
    return t.prototype = {
        ...
        refixAxisShape: function(e) {
            ...
            n.type == a.COMPONENT_TYPE_AXIS_VALUE && 0 > n._min && n._max >= 0 && (n.isHorizontal() ? t = n.getCoord(0) : i = n.getCoord(0));
            if (t !== void 0 || i !== void 0) for (r = o.length; r--;) o[r].refixAxisShape(t, i)
        },
        refresh: function(e) {
            if (e || this._zrWidth != this.zr.getWidth() || this._zrHeight != this.zr.getHeight()) {
                ...
                this._width = t.width === void 0 ? this._zrWidth - this._x - i: this.parsePercent(t.width, this._zrWidth),
                this._width = 0 >= this._width ? 10 : this._width,
                this._height = t.height === void 0 ? this._zrHeight - this._y - a: this.parsePercent(t.height, this._zrHeight),
    ...
    return t.prototype = {
        ...
        _getZoom: function() {
            ...
            h = e.length; h > l; l++) if (d = e[l], d.type == r.CHART_TYPE_LINE || d.type == r.CHART_TYPE_BAR || d.type == r.CHART_TYPE_SCATTER || d.type == r.CHART_TYPE_K) {
                for (var m = 0,
                c = n.length; c > m; m++) if (n[m] == (d.xAxisIndex || 0)) {
                    o.push(l);
                    break
                }
                for (var m = 0,
                c = a.length; c > m; m++) if (a[m] == (d.yAxisIndex || 0)) {
                    o.push(l);
                    break
                }
        ...
        _buildBackground: function() {
            ...
            m = this._zoom.yAxisIndex,
            l = 0,
            h = m.length; h > l; l++) i = Math.max(i, d[m[l]].length);
            for (var c, p = this._zoom.seriesIndex[0], u = this._originalData.series[p], V = Number.MIN_VALUE, U = Number.MAX_VALUE, l = 0, h = u.length; h > l; l++) c = this.getDataFromOption(u[l], 0),
            this.option.series[p].type == r.CHART_TYPE_K && (c = c[1]),
            isNaN(c) && (c = 0),
            V = Math.max(V, c),
            U = Math.min(U, c);
            var g = V - U,
            ...
            for (var l = 0,
            h = i; h > l; l += _) c = this.getDataFromOption(u[l], 0),
            this.option.series[p].type == r.CHART_TYPE_K && (c = c[1]),
            isNaN(c) && (c = 0),
            "horizontal" == this.zoomOption.orient ? y.push([this._location.x + f * l, this._location.y + t - 1 - Math.round((c - U) / g * (t - 10))]) : y.push([this._location.x + 1 + Math.round((c - U) / g * (e - 10)), this._location.y + b * (h - l - 1)]);
            "horizontal" == this.zoomOption.orient ? (y.push([this._location.x + e, this._location.y + t]), y.push([this._location.x, this._location.y + t])) : (y.push([this._location.x, this._location.y]), y.push([this._location.x, this._location.y + t])),
            this.shapeList.push(new a({
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
        ...
        _syncFillerShape: function() {
            var e, t;
            "horizontal" == this.zoomOption.orient ? (e = this._startShape.style.x, t = this._endShape.style.x, this._fillerShae.style.x = Math.min(e, t) + this._handleSize, this._fillerShae.style.width = Math.abs(e - t) - this._handleSize, this._zoom.start = 100 * ((Math.min(e, t) - this._location.x) / this._location.width), this._zoom.end = 100 * ((Math.max(e, t) + this._handleSize - this._location.x) / this._location.width)) : (e = this._startShape.style.y, t = this._endShape.style.y, this._fillerShae.style.y = Math.min(e, t) + this._handleSize, this._fillerShae.style.height = Math.abs(e - t) - this._handleSize, this._zoom.start = 100 * ((this._location.y + this._location.height - Math.max(e, t)) / this._location.height), this._zoom.end = 100 * ((this._location.y + this._location.height - Math.min(e, t) - this._handleSize) / this._location.height)),
        ...
        _synScatterData: function(e, t) {
            ...
            for (var h, d = 0,
            m = t.length; m > d; d++) h = t[d].value || t[d],
            h[0] >= n && a >= h[0] && h[1] >= o && r >= h[1] && s.push(t[d]);
            return s
        },
        _setScale: function() {
        ...
        _getDetail: function() {
            ...
            m = this.option.series[d][e + "Index"] || 0,
            c = this.option[e][m].type,
        ...
        rectZoom: function(e) {
            ...
            if (0 > i.width && (i.x += i.width, i.width = -i.width), 0 > i.height && (i.y += i.height, i.height = -i.height), i.x > t.x + t.width || i.y > t.y + t.height) return ! 1;
            i.x < t.x && (i.x = t.x),
...
function(e) {
    function t(e, t, n, a, o, r) {
        if (1 > a.data.length) return console.error("option.data.length < 1."),
        void 0;
        i.call(this, e, t, n, a, o),
    ...
    return t.prototype = {
                ...
                if (this.isHorizontal()) if (n > 3) {
                    ...
                    for (d = 1 > d ? 1 : d, e = Math.floor(15 / r); ! h && n > e;) {
                        ...
                        for (var m = Math.floor((n - 1) / e) * e; m >= 0; m -= e) {
                            ...
                            else if (i[m].textStyle) o = l.getTextWidth(this._getReformedLabel(m), this.getFont(s.merge(i[m].textStyle, this.option.axisLabel.textStyle)));
                            else {
                                var c = this._getReformedLabel(m) + "",
        ...
        _buildAxisTick: function() {
            ...
            r = n.lineStyle.color,
            s = n.lineStyle.width,
            l = "function" == typeof n.interval ? n.interval: "auto" == n.interval ? "function" == typeof this.option.axisLabel.interval ? this.option.axisLabel.interval: !1 : !1,
            h = l ? 1 : "auto" == n.interval ? this._interval: n.interval - 0 + 1,
            d = n.onGap,
            m = d ? this.getGap() / 2 : d === void 0 ? this.option.boundaryGap ? this.getGap() / 2 : 0 : 0,
            c = m > 0 ? -h: 0;
            if (this.isHorizontal()) for (var p, u = "bottom" == this.option.position ? n.inside ? this.grid.getYend() - o - 1 : this.grid.getYend() + 1 : n.inside ? this.grid.getY() + 1 : this.grid.getY() - o - 1, V = c; i > V; V += h)(!l || l(V, t[V])) && (p = this.subPixelOptimize(this.getCoordByIndex(V) + (V >= 0 ? m: 0), s), e = {
                _axisShape: "axisTick",
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
            ...
            else for (var U, g = "left" == this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, V = c; i > V; V += h)(!l || l(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - (V >= 0 ? m: 0), s), e = {
                _axisShape: "axisTick",
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
        ...
        _buildAxisLabel: function() {
            ...
            h = o.clickable,
            d = o.textStyle,
            m = "function" == typeof o.interval ? o.interval: !1;
            if (this.isHorizontal()) {
                var c, p;
                "bottom" == this.option.position ? (c = this.grid.getYend() + l, p = "top") : (c = this.grid.getY() - l, p = "bottom");
                for (var u = 0; a > u; u += this._interval) m && !m(u, i[u]) || "" === this._getReformedLabel(u) || (t = s.merge(i[u].textStyle || {},
                d), e = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase() + 3,
                    hoverable: !1,
        ...
        _buildSplitLine: function() {
            ...
            d = n.onGap,
            m = d ? this.getGap() / 2 : d === void 0 ? this.option.boundaryGap ? this.getGap() / 2 : 0 : 0;
            if (i -= d || d === void 0 && this.option.boundaryGap ? 1 : 0, this.isHorizontal()) for (var c, p = this.grid.getY(), u = this.grid.getYend(), V = 0; i > V; V += this._interval)(!h || h(V, t[V])) && (c = this.subPixelOptimize(this.getCoordByIndex(V) + m, r), e = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
                style: {
            ...
            this.shapeList.push(new a(e)));
            else for (var U, g = this.grid.getX(), y = this.grid.getXend(), V = 0; i > V; V += this._interval)(!h || h(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - m, r), e = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
                style: {
        ...
        _buildSplitArea: function() {
            ...
            if (n instanceof Array) {
                ...
                l = i.onGap,
                h = l ? this.getGap() / 2 : l === void 0 ? this.option.boundaryGap ? this.getGap() / 2 : 0 : 0;
                if (this.isHorizontal()) for (var d, m = this.grid.getY(), c = this.grid.getHeight(), p = this.grid.getX(), u = 0; r >= u; u += this._interval) s && !s(u, t[u]) && r > u || (d = r > u ? this.getCoordByIndex(u) + h: this.grid.getXend(), e = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {
                ...
                else for (var V, U = this.grid.getX(), g = this.grid.getWidth(), y = this.grid.getYend(), u = 0; r >= u; u += this._interval) s && !s(u, t[u]) && r > u || (V = r > u ? this.getCoordByIndex(u) - h: this.grid.getY(), e = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {
                ...
                this.shapeList.push(new o(e)), y = V)
            } else e = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
...
define("echarts/component/valueAxis", ["require", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "../config", "../util/date", "zrender/tool/util", "../util/smartSteps", "../util/accMath", "../component"],
function(e) {
    function t(e, t, n, a, o, r, s) {
        if (!s || 0 === s.length) return console.err("option.series.length == 0."),
        void 0;
        i.call(this, e, t, n, a, o),
        this.series = s,
        this.grid = this.component.grid;
    ...
    return t.prototype = {
        ...
        _buildAxisTick: function() {
            ...
            this.shapeList.push(new a(e));
            else for (var m, c = "left" === this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, d = 0; i > d; d++) m = this.subPixelOptimize(this.getCoord(t[d]), s),
            e = {
                _axisShape: "axisTick",
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
        ...
        _buildSplitLine: function() {
            ...
            s = s instanceof Array ? s: [s];
            var l = s.length;
            if (this.isHorizontal()) for (var h, d = this.grid.getY(), m = this.grid.getYend(), c = 0; i > c; c++) h = this.subPixelOptimize(this.getCoord(t[c]), r),
            e = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
            ...
            this.shapeList.push(new a(e));
            else for (var p, u = this.grid.getX(), V = this.grid.getXend(), c = 0; i > c; c++) p = this.subPixelOptimize(this.getCoord(t[c]), r),
            e = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
        ...
        _buildSplitArea: function() {
            ...
            if (t instanceof Array) {
                ...
                this.shapeList.push(new o(e)),
                h = r;
                else for (var m, c = this.grid.getX(), p = this.grid.getWidth(), u = this.grid.getYend(), d = 0; a >= d; d++) m = a > d ? this.getCoord(n[d]) : this.grid.getY(),
                e = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
        ...
        _calculateValue: function() {
            if (isNaN(this.option.min - 0) || isNaN(this.option.max - 0)) {
                ...
                this._min = isNaN(this.option.min - 0) ? this._min - Math.abs(d * this.option.boundaryGap[0]) : this.option.min - 0,
                this._max = isNaN(this.option.max - 0) ? this._max + Math.abs(d * this.option.boundaryGap[1]) : this.option.max - 0,
        ...
        _calculSum: function(e, t) {
            ...
            if (this.series[t].stack) {
                ...
                n = this.series[t].data;
                for (var h = 0,
                d = n.length; d > h; h++) for (var m = n[h].evolution, c = 0, p = m.length; p > c; c++) e[a].push(s.getNewDate(m[c].time))
            }
        },
        _reformValue: function(t) {
            var i = e("../util/smartSteps"),
            n = this.option.splitNumber; ! t && this._min >= 0 && this._max >= 0 && (this._min = 0),
            !t && 0 >= this._min && 0 >= this._max && (this._max = 0);
        ...
        _reformTimeValue: function() {
            ...
            for (n / 2 > a - this._min && (a -= -n), t = s.getNewDate(a), e *= 1.5; e-->=0 && (("month" == i || "quarter" == i || "half-year" == i || "year" == i) && t.setDate(1), !(n / 2 > this._max - t));) this._valueList.push(t),
            t = s.getNewDate(t - -n);
        ...
        _reformLabelData: function(e) {
            ...
            else if (e) for (var i = 0,
            n = this._valueList.length; n > i; i++) this._valueLabel.push(s.format(e, this._valueList[i]));
            else for (var i = 0,
            n = this._valueList.length; n > i; i++) this._valueLabel.push(this.numAddCommas(this._valueList[i]))
        },
        ...
        getValueFromCoord: function(e) {
            var t;
            return this.isHorizontal() ? (e = this.grid.getX() > e ? this.grid.getX() : e, e = e > this.grid.getXend() ? this.grid.getXend() : e, t = this._min + (e - this.grid.getX()) / this.grid.getWidth() * (this._max - this._min)) : (e = this.grid.getY() > e ? this.grid.getY() : e, e = e > this.grid.getYend() ? this.grid.getYend() : e, t = this._max - (e - this.grid.getY()) / this.grid.getHeight() * (this._max - this._min)),
            t.toFixed(2) - 0
        },
...
function() {
    function e(e, t, i) {
        i = i > 1 ? i: 2;
        for (var n, a, o, r, s = 0,
        l = d.length; l > s; s++) if (n = d[s].value, a = Math.ceil(t / n) * n - Math.floor(e / n) * n, 1.2 * i >= Math.round(a / n)) {
            o = d[s].formatter,
            r = d[s].value;
            break
        }
...
function() {
    ...
    function n(e, t, n, a) {
        ...
        t = +t || 0,
        x = k = 0,
        "min" in f && (e = +f.min || 0, x = 1),
        "max" in f && (t = +f.max || 0, k = 1),
        e > t && (t = [e, e = t][0]);
        var o = t - e;
        if (x && k) return y(e, t, n);
        if ((n || 5) > o) {
    ...
    function o(n, a, o) {
        a = w(a % 10) || 2,
        0 > a && (i(n) ? a = ("" + K(n)).replace(/0+$/, "").length || 1 : (n = n.toFixed(15).replace(/0+$/, ""), a = n.replace(".", "").replace(/^[-0]+/, "").length, n = +n));
        var r = X(e(n)) - a + 1,
        s = +(n * t( - r)).toFixed(15) || 0;
        return s = o ? X(s) : I(s),
        !s && (r = 0),
        ("" + K(s)).length > a && (r += 1, s /= 10),
        {
            c: s,
            e: r
        }
    ...
    function h(e, t, n) {
        ...
        y = o(e, -1, 1),
        f = o(t, -1);
        if (r(U, u), r(y, u, 1), r(f, u), n ? s = m(y, f, h) : h = d(y, f), i(e) && i(t) && e * t >= 0) {
    ...
    function m(e, i, n) {
        ...
        d = o - i.c,
        m = h - d;
        return m > 1.1 * s && (m = w(m / s / 2) * s, r += m, o += m),
        e.c = r,
        i.c = o,
        s
    }
    ...
    function y(e, t, i) {
        ...
        1e-6 > K(t / s) && (t = 0),
        1e-6 > K(e / s) && (e = 0);
        var l, h, d, m = [[5, 10], [10, 2], [50, 10], [100, 2]],
        c = [],
        p = [],
        u = o(t - e, 3),
        V = o(e, -1, 1),
        ...
        for (var g = n.length; g--;) {
            ...
            d += 2 * (i - n[0] + 2),
            0 === i % 5 && (d -= 10);
            for (var y = m.length; y--;) 0 === l % m[y][0] && (d /= m[y][1]);
            p[g] = [i, l, h, d].join(),
            c[g] = {
                secs: i,
                step: l,
        ...
        V.c = w(V.c - c.delta / 2),
        U.c = w(U.c + c.delta / 2),
        a(V.c, U.c, c.secs, u.e)
    }
    var f, b, _, x, k, v = [10, 20, 25, 50],
    L = [4, 5, 6],
    W = Math,
    w = W.round,
    X = W.floor,
